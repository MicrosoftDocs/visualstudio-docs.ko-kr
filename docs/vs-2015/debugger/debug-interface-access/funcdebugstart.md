...
함수가 디버깅을 시작할 수 있는 정의 된 지점을 포함 하는 경우 해당 지점은 태그가 있는 기호로 식별 됩니다 `SymTagFuncDebugStart` .  
...
|[IDiaSymbol::get_isStatic](../../debugger/debug-interface-access/idiasymbol-get-isstatic.md)|`BOOL`|`TRUE` 함수가 static으로 표시 된 경우 (DIA SDK v 8.0 이상 에서만)|  
...
|[IDiaSymbol::get_symTag](../../debugger/debug-interface-access/idiasymbol-get-symtag.md)|`DWORD`|`SymTagFuncDebugStart` [SymTagEnum 열거형](../../debugger/debug-interface-access/symtagenum.md) 값 중 하나를 반환 합니다.|  
