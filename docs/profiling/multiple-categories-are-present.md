---
title: 범주가 여러 개 있는 경우 | Microsoft Docs
description: 지정된 시간 범위 동안 한 섹션에 둘 이상의 작업 종류가 포함되는 경우 두 가지 색이 표시되고 한 색 위에 다른 색이 세로로 쌓여져 표시되는 것을 알아봅니다.
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
...
- [일시 중지 시간](../profiling/sleep-time.md)
