...
- Deserialize 된 형식을 제한 합니다. 사용자 지정를 구현 <xref:System.Runtime.Serialization.SerializationBinder?displayProperty=nameWithType> 합니다. 로 deserialize 하기 전에 <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter> 속성을 <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> 사용자 지정의 인스턴스로 설정 합니다 <xref:System.Runtime.Serialization.SerializationBinder> . 재정의 된 <xref:System.Runtime.Serialization.SerializationBinder.BindToType%2A> 메서드에서 형식이 예기치 않은 경우 예외를 throw 하 여 deserialization을 중지 합니다.
  - Deserialize 된 형식을 제한 하는 경우이 규칙을 사용 하지 않도록 설정 하 고 [CA2301](ca2301.md) 및 [CA2302](ca2302.md)규칙을 사용 하도록 설정 하는 것이 좋습니다. [CA2301](ca2301.md) 및 [CA2302](ca2302.md) 규칙은 <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> deserialize 전에 속성이 항상 설정 되도록 하는 데 도움이 됩니다.
