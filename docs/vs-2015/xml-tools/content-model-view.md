...
## <a name="workspace-panel"></a>작업 영역 패널
 작업 영역에 노드를 추가하면 노드 목록이 콘텐츠 모델 뷰의 **작업 영역** 패널에 나타납니다. **작업 영역** 패널에 있는 노드를 선택하면 해당 노드가 콘텐츠 모델 뷰 디자인 화면에 나타납니다. 작업 psace에서 노드를 삭제 하려면 XSD 디자이너 도구 모음, **작업 영역** 패널 상황에 맞는 메뉴 또는 delete 키를 사용 합니다.
...
## <a name="xml-editor-integration"></a>XML 편집기 통합
 ...
 XML 편집기에서 스키마 집합을 변경하면 해당 변경 내용이 콘텐츠 모델 뷰에서 동기화됩니다. 자세한 내용은 [XML 편집기와의 통합](../xml-tools/integration-with-xml-editor.md)을 참조 하세요.
