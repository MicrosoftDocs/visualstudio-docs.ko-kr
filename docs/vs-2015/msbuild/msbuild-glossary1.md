 ...
 *메타데이터, 항목*을 참조하세요.
 ...
 환경 속성은 이름이 같은 시스템 환경 변수의 값으로 자동 초기화되는 속성입니다. 자세한 내용은 [MSBuild 속성](msbuild-properties1.md)을 참조하세요.
 ...
 전역 속성은 빌드 프로세스를 제어하는 데 사용되는 키/값 쌍입니다. 전역 속성은 명령 프롬프트에서 설정하거나 [MSBuild 작업](../msbuild/msbuild-task.md)의 `Properties` 특성을 사용하여 설정하며, 빌드의 평가 단계 중에는 수정할 수 없습니다. 자세한 내용은 [MSBuild 속성](msbuild-properties1.md)을 참조하세요.
 ...
 레지스트리 속성은 시스템 레지스트리 하위 키의 값을 읽는 특수 구문을 사용하여 설정되는 값을 포함합니다. 자세한 내용은 [MSBuild 속성](msbuild-properties1.md)을 참조하세요.

 속성, 예약

 예약된 속성은 빌드 프로세스를 제어하는 데 사용되는 키/값 쌍입니다. 예약된 속성은 미리 정의된 값으로 자동 초기화됩니다. 자세한 내용은 [MSBuild 속성](msbuild-properties1.md)을 참조하세요.
