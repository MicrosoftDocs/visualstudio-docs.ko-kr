...
description: 메뉴 요소는 하나의 메뉴 항목을 정의 합니다. 메뉴 종류에는 컨텍스트, 메뉴, 메뉴 컨트롤러, 메뉴 메뉴, 도구 모음 및 ToolWindowToolbar가 있습니다.
