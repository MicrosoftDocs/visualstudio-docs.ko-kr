# [디버그 인터페이스 액세스 SDK](debug-interface-access-sdk.md)
## [시작](getting-started-debug-interface-access-sdk.md)
### [개요](overview-debug-interface-access-sdk.md)
### [.Pdb 파일 쿼리](querying-the-dot-pdb-file.md)
## [기호 및 기호 태그](symbols-and-symbol-tags.md)
### [기호 위치](symbol-locations.md)
### [기호 형식의 어휘 계층 구조](lexical-hierarchy-of-symbol-types.md)
#### [주석](annotation.md)
#### [블록](block.md)
#### [컴파일 대상](compiland.md)
#### [CompilandDetails](compilanddetails.md)
#### [CompilandEnv](compilandenv.md)
#### [사용자 지정(디버그 인터페이스 액세스 SDK)](custom-debug-interface-access-sdk.md)
#### [데이터(디버그 인터페이스 액세스 SDK)](data-debug-interface-access-sdk.md)
#### [Exe](exe.md)
#### [함수(디버그 인터페이스 액세스 SDK)](function-debug-interface-access-sdk.md)
#### [FuncDebugEnd](funcdebugend.md)
#### [FuncDebugStart](funcdebugstart.md)
#### [레이블(디버그 인터페이스 액세스 SDK)](label-debug-interface-access-sdk.md)
#### [PublicSymbol](publicsymbol.md)
#### [썽크](thunk.md)
#### [UsingNameSpace](usingnamespace.md)
### [기호 형식의 클래스 계층 구조](class-hierarchy-of-symbol-types.md)
...
#### [Typedef(디버그 인터페이스 액세스 SDK)](typedef-debug-interface-access-sdk.md)
#### [UDT](udt.md)
#### [VTable](vtable.md)
