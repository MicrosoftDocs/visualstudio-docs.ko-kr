---
title: 'CA5388: 약한 키 파생 함수를 사용 하는 경우 충분 한 반복 횟수를 확인 합니다.'
...
ms.locfileid: "84184982"
---
# <a name="ca5388-ensure-sufficient-iteration-count-when-using-weak-key-derivation-function"></a>CA5388: 약한 키 파생 함수를 사용 하는 경우 충분 한 반복 횟수를 확인 합니다.
