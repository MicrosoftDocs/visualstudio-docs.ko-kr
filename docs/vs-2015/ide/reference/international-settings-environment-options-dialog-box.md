 ...
 **언어** 설치된 제품 언어 버전에 대해 사용 가능한 언어를 나열합니다. 이 옵션은 컴퓨터에 여러 언어 버전이 설치되어 있지 않은 경우 사용할 수 없습니다. 제품의 여러 언어나 제품의 혼합 언어 설치가 환경을 공유하는 경우 선택 언어는 **Microsoft Windows와 같음**으로 변경됩니다.
