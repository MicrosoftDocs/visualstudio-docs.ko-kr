...
| CA1834 |[CA1834: 단일 문자열에 대해 StringBuilder.Append(char)를 사용하세요.](../code-quality/ca1834.md) | <xref:System.Text.StringBuilder>`Append`에는를 인수로 사용 하는 오버 로드가 있습니다 `char` . 성능상의 이유로 오버 로드를 호출 하는 것이 좋습니다 `char` . |
