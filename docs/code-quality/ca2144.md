---
title: 'CA2144: 투명 코드는 바이트 배열에서 어셈블리를 로드해서는 안 됩니다.'
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2144
...
이 규칙 위반 문제를 해결 하려면 어셈블리를 로드 하는 메서드를 <xref:System.Security.SecurityCriticalAttribute> 또는 <xref:System.Security.SecuritySafeCriticalAttribute> 특성으로 표시 합니다.
