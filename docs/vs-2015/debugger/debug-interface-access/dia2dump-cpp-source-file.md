---
title: Dia2dump 소스 파일 | Microsoft Docs
ms.date: 11/15/2016
...
ms.locfileid: "68197607"
---
# <a name="dia2dumpcpp-source-file"></a>Dia2dump.cpp 소스 파일
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

다음 Dia2dump 소스 코드는 .pdb 파일의 내용을 표시 합니다. 이 소스 코드는 [Dia2dump 샘플](../../debugger/debug-interface-access/dia2dump-sample.md)에서 사용 됩니다.  
