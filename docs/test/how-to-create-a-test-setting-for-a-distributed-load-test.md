...
description: 테스트 에이전트와 테스트 컨트롤러를 사용하여 테스트를 여러 컴퓨터에 분산할 수 있도록 부하 테스트의 테스트 설정을 구성하는 방법을 알아봅니다.
...
20. 테스트를 실행할 때마다 배포에 사용할 디렉터리를 개별적으로 만들려면 **배포 가능** 을 선택합니다.
    ...
    > [!NOTE]
    > 이렇게 하면 테스트를 실행할 때 애플리케이션을 계속 빌드할 수 있습니다.
