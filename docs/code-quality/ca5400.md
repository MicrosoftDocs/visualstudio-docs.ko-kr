---
title: 'CA5400: HttpClient 인증서 해지 목록 확인이 사용 하도록 설정 되어 있지 않은지 확인 합니다.'
...
ms.locfileid: "84184880"
---
# <a name="ca5400-ensure-httpclient-certificate-revocation-list-check-is-not-disabled"></a>CA5400: HttpClient 인증서 해지 목록 확인이 사용 하도록 설정 되어 있지 않은지 확인 합니다.
