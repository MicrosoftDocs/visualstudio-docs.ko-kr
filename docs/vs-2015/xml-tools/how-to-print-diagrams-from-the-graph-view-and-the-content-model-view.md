...
1. Visual Studio에서 XSD 파일을 열고 일부 노드를 [XML 스키마 디자이너 작업 영역](../xml-tools/xml-schema-designer-workspace.md)에 추가 합니다.

2. **다이어그램을 이미지로 내보내기 ...** 를 사용 하 여 다이어그램을 XPS 파일로 내보냅니다. 그래프 뷰 또는 콘텐츠 모델 뷰의 디자인 화면에 있는 상황에 맞는 메뉴 항목입니다.
...
## <a name="see-also"></a>관련 항목
 [그래프 뷰](../xml-tools/graph-view.md) [콘텐츠 모델 뷰](../xml-tools/content-model-view.md) [XML 스키마 디자이너 작업 영역](../xml-tools/xml-schema-designer-workspace.md)
