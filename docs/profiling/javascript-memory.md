...
description: JavaScript 메모리 분석기를 통해 JavaScript를 사용하여 Windows용으로 빌드된 UWP 앱의 메모리 사용량을 파악하고 메모리 누수를 찾는 방법을 알아봅니다.
ms.custom: ''
ms.date: 11/04/2016
ms.topic: how-to
dev_langs:
...
- [UWP 앱에서 메모리 관리](/archive/msdn-magazine/2012/windows-8-special-issue/javascript-managing-memory-in-windows-store-apps)를 참조하세요.
