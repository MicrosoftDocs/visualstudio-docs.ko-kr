---
title: 'CA2244: 인덱싱된 요소 초기화를 복제 하지 마십시오.'
ms.date: 04/30/2020
ms.topic: reference
f1_keywords:
- CA2244
...
ms.locfileid: "84184910"
---
# <a name="ca2244-do-not-duplicate-indexed-element-initializations"></a>CA2244: 인덱싱된 요소 초기화를 복제 하지 마십시오.
