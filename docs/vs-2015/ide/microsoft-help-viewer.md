...
- 작은 삼각형은 항목 탭 및 **콘텐츠 관리** 탭을 비롯 한 탭의 목록을 엽니다. 해당 탭을 선택 하 여 활성 상태로 만들 수 있습니다.
