...
## <a name="example"></a>예
다음 예제에서는 IDebugPendingBreakpoint2 인터페이스를 구현 하는 간단한 개체에 대해이 메서드를 구현 하는 방법을 보여 줍니다 `CPendingBreakpoint` . [IDebugPendingBreakpoint2](../../../extensibility/debugger/reference/idebugpendingbreakpoint2.md)
