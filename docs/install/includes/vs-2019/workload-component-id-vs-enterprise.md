...
**설명:** .NET 및 .NET Framework를 사용하여 클라우드 앱을 개발하고 리소스를 만들기 위한 Azure SDK, 도구, 프로젝트입니다. Docker 지원을 포함하여, 애플리케이션을 컨테이너화하기 위한 도구도 포함되어 있습니다.

### <a name="components-included-by-this-workload"></a>이 작업에 포함되는 구성 요소

구성 요소 ID | Name | 버전 | 종속성 유형
--- | --- | --- | ---
Component.Microsoft.VisualStudio.RazorExtension | Razor 언어 서비스 | 16.10.31205.252 | 필수
Component.Microsoft.VisualStudio.Web.AzureFunctions | Azure WebJobs Tools | 16.10.31205.252 | 필수
Component.Microsoft.Web.LibraryManager | 라이브러리 관리자 | 16.10.31205.180 | 필수
Component.Microsoft.WebTools.BrowserLink.WebLivePreview | 웹 실시간 미리 보기 | 0.7.22.39845 | 필수
Microsoft.Component.MSBuild | MSBuild | 16.5.29515.121 | 필수
Microsoft.ComponentGroup.ClickOnce.Publish | .NET용 ClickOnce 게시  | 16.10.31303.231 | 필수
...
Microsoft.NetCore.Component.DevelopmentTools | .NET 개발 도구 | 16.10.31303.231 | 필수
...
Microsoft.NetCore.Component.Web | .NET 개발 도구 | 16.10.31303.231 | 필수
...
Microsoft.VisualStudio.Component.Azure.Compute.Emulator | Azure 컴퓨팅 에뮬레이터 | 16.10.31205.252 | 필수
...
Microsoft.VisualStudio.Component.JavaScript.TypeScript | TypeScript 및 JavaScript 언어 지원 | 16.10.31303.231 | 필수
...
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 및 Visual Basic | 16.10.31205.252 | 필수
...
Microsoft.VisualStudio.Component.Web | ASP.NET 및 웹 개발 도구 | 16.10.31205.252 | 필수
Microsoft.VisualStudio.ComponentGroup.Azure.Prerequisites | Azure 개발 필수 구성 요소 | 16.10.31303.231 | 필수
Microsoft.VisualStudio.ComponentGroup.AzureFunctions | Azure WebJobs Tools | 16.10.31205.180 | 필수
Microsoft.VisualStudio.ComponentGroup.Web | ASP.NET 및 웹 개발 도구 필수 조건 | 16.10.31205.180 | 필수
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 및 웹 개발 | 16.10.31205.180 | 필수
Microsoft.Component.Azure.DataLake.Tools | Azure Data Lake 및 Stream Analytics 도구 | 16.10.31205.252 | 권장
...
Microsoft.VisualStudio.Component.Azure.Kubernetes.Tools | Visual Studio Tools for Kubernetes | 16.10.31205.252 | 권장
...
Microsoft.VisualStudio.Component.Azure.Waverton | Azure Cloud Services 핵심 도구 | 16.10.31205.252 | 권장
Microsoft.VisualStudio.Component.Azure.Waverton.BuildTools | Azure Cloud Services 빌드 도구 | 16.10.31205.252 | 권장
Microsoft.VisualStudio.Component.Debugger.Snapshot | 스냅샷 디버거 | 16.5.29813.82 | 권장
Microsoft.VisualStudio.Component.Debugger.TimeTravel | 시간 이동 디버거 | 16.10.31205.252 | 권장
Microsoft.VisualStudio.Component.DiagnosticTools | .NET 프로파일링 도구 | 16.10.31205.252 | 권장
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 16.10.31305.154 | 권장
...
Microsoft.VisualStudio.ComponentGroup.Azure.CloudServices | Azure Cloud Services 도구 | 16.10.31205.180 | 권장
...
구성 요소 ID | Name | 버전 | 종속성 유형
--- | --- | --- | ---
Component.Microsoft.VisualStudio.RazorExtension | Razor 언어 서비스 | 16.10.31205.252 | 권장
Component.Microsoft.Web.LibraryManager | 라이브러리 관리자 | 16.10.31205.180 | 권장
Component.Microsoft.WebTools.BrowserLink.WebLivePreview | 웹 실시간 미리 보기 | 0.7.22.39845 | 권장
Microsoft.Component.Azure.DataLake.Tools | Azure Data Lake 및 Stream Analytics 도구 | 16.10.31205.252 | 권장
...
Microsoft.Net.Component.4.6.TargetingPack | .NET Framework 4.6 타기팅 팩 | 16.0.28517.75 | 권장
Microsoft.Net.Component.4.7.2.TargetingPack | .NET Framework 4.7.2 타기팅 팩 | 16.10.31205.252 | 권장
...
Microsoft.VisualStudio.Component.Azure.Compute.Emulator | Azure 컴퓨팅 에뮬레이터 | 16.10.31205.252 | 권장
...
Microsoft.VisualStudio.Component.JavaScript.TypeScript | TypeScript 및 JavaScript 언어 지원 | 16.10.31303.231 | 권장
...
Microsoft.VisualStudio.Component.TypeScript.4.2 | TypeScript 4.2 SDK | 16.0.31303.231 | 권장
Microsoft.VisualStudio.Component.Web | ASP.NET 및 웹 개발 도구 | 16.10.31205.252 | 권장
Microsoft.VisualStudio.ComponentGroup.Web | ASP.NET 및 웹 개발 도구 필수 조건 | 16.10.31205.180 | 권장
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 및 웹 개발 | 16.10.31205.180 | 권장
...
구성 요소 ID | Name | 버전 | 종속성 유형
--- | --- | --- | ---
Microsoft.Component.PythonTools | Python 언어 지원 | 16.10.31313.127 | 권장
Microsoft.Component.PythonTools.Minicondax64 | Python miniconda(지원되지 않음) | 16.10.31313.127 | 권장
Microsoft.Component.PythonTools.Web | Python 웹 지원 | 16.10.31205.252 | 권장
...
Microsoft.VisualStudio.Component.WebDeploy | 웹 배포 | 16.0.28517.75 | 권장
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 및 웹 개발 | 16.10.31205.180 | 권장
Microsoft.ComponentGroup.PythonTools.NativeDevelopment | Python 네이티브 개발 도구 | 16.10.31205.180 | 옵션
Microsoft.VisualStudio.Component.Graphics.Tools | DirectX용 그래픽 디버거 및 GPU 프로파일러 | 16.0.28625.61 | 옵션
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 핵심 기능 | 16.10.31205.252 | 옵션
...
Microsoft.VisualStudio.Component.Windows10SDK.19041 | Windows 10 SDK(10.0.19041.0) | 16.10.31205.252 | 옵션

## <a name="net-desktop-development"></a>.NET 데스크톱 개발

**ID:** Microsoft.VisualStudio.Workload.ManagedDesktop

**설명:** .NET 및 .NET Framework와 함께 C#, Visual Basic, F#을 사용하여 WPF, Windows Forms, 콘솔 애플리케이션을 빌드합니다.
...
Microsoft.NetCore.Component.SDK | .NET SDK | 16.10.31320.204 | 필수
Microsoft.VisualStudio.Component.ManagedDesktop.Core | 관리되는 데스크톱 워크로드 핵심 | 16.4.29318.151 | 필수
Microsoft.VisualStudio.Component.ManagedDesktop.Prerequisites | .NET 데스크톱 개발 도구 | 16.10.31205.180 | 필수
Microsoft.VisualStudio.Component.Roslyn.Compiler | C# 및 Visual Basic Roslyn 컴파일러 | 16.0.28714.129 | 필수
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 및 Visual Basic | 16.10.31205.252 | 필수
Microsoft.VisualStudio.Component.SQL.CLR | SQL Server용 CLR 데이터 형식 | 16.0.28315.86 | 필수
Microsoft.VisualStudio.Component.TextTemplating | 텍스트 템플릿 변환 | 16.0.28625.61 | 필수
Component.Microsoft.VisualStudio.LiveShare | Live Share | 1.0.4062 | 권장
Microsoft.ComponentGroup.Blend | Visual Studio용 Blend | 16.0.28315.86 | 권장
Microsoft.ComponentGroup.ClickOnce.Publish | .NET용 ClickOnce 게시  | 16.10.31303.231 | 권장
Microsoft.Net.Component.4.5.1.TargetingPack | .NET Framework 4.5.1 타기팅 팩 | 16.0.28517.75 | 권장
Microsoft.Net.Component.4.5.2.TargetingPack | .NET Framework 4.5.2 타기팅 팩 | 16.0.28517.75 | 권장
Microsoft.Net.Component.4.5.TargetingPack | .NET Framework 4.5 타기팅 팩 | 16.0.28517.75 | 권장
Microsoft.Net.Component.4.6.1.TargetingPack | .NET Framework 4.6.1 타기팅 팩 | 16.0.28517.75 | 권장
...
Microsoft.Net.Component.4.TargetingPack | .NET Framework 4 타기팅 팩 | 16.0.28517.75 | 권장
Microsoft.Net.ComponentGroup.TargetingPacks.Common | .NET Framework 4 – 4.6 개발 도구 | 16.0.28516.191 | 권장
Microsoft.NetCore.Component.DevelopmentTools | .NET 개발 도구 | 16.10.31303.231 | 권장
Microsoft.VisualStudio.Component.Common.Azure.Tools | 연결 및 게시 도구 | 16.4.29409.204 | 권장
Microsoft.VisualStudio.Component.Debugger.JustInTime | Just-In-Time 디버거 | 16.0.28517.75 | 권장
Microsoft.VisualStudio.Component.DiagnosticTools | .NET 프로파일링 도구 | 16.10.31205.252 | 권장
Microsoft.VisualStudio.Component.DotNetModelBuilder | ML.NET 모델 작성기(미리 보기) | 16.10.31205.252 | 권장
...
Microsoft.VisualStudio.Component.IntelliTrace.FrontEnd | IntelliTrace | 16.5.29515.121 | 권장
Microsoft.VisualStudio.Component.JavaScript.TypeScript | TypeScript 및 JavaScript 언어 지원 | 16.10.31303.231 | 권장
Microsoft.VisualStudio.Component.LiveUnitTesting | Live Unit Testing | 16.10.31205.252 | 권장
Microsoft.VisualStudio.Component.NuGet | NuGet 패키지 관리자 | 16.1.28829.92 | 권장
Microsoft.VisualStudio.Component.TypeScript.4.2 | TypeScript 4.2 SDK | 16.0.31303.231 | 권장
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 및 웹 개발 | 16.10.31205.180 | 권장
Component.Dotfuscator | PreEmptive Protection - Dotfuscator | 16.10.31205.252 | 옵션
Component.Microsoft.VisualStudio.RazorExtension | Razor 언어 서비스 | 16.10.31205.252 | 옵션
Component.Microsoft.Web.LibraryManager | 라이브러리 관리자 | 16.10.31205.180 | Optional
Component.Microsoft.WebTools.BrowserLink.WebLivePreview | 웹 실시간 미리 보기 | 0.7.22.39845 | 옵션
Microsoft.Net.Component.4.6.2.TargetingPack | .NET Framework 4.6.2 타기팅 팩 | 16.0.28517.75 | 옵션
Microsoft.Net.Component.4.7.1.TargetingPack | .NET Framework 4.7.1 타기팅 팩 | 16.10.31205.252 | 옵션
Microsoft.Net.Component.4.7.TargetingPack | .NET Framework 4.7 타기팅 팩 | 16.10.31205.252 | 옵션
Microsoft.Net.Component.4.8.TargetingPack | .NET Framework 4.8 타기팅 팩 | 16.4.29313.120 | 옵션
...
Microsoft.VisualStudio.Component.PortableLibrary | .NET 이식이 가능한 라이브러리 타기팅 팩 | 16.10.31205.252 | 옵션
...
Microsoft.VisualStudio.Component.Wcf.Tooling | Windows Communication Foundation | 16.0.28625.61 | 옵션
Microsoft.VisualStudio.Component.Web | ASP.NET 및 웹 개발 도구 | 16.10.31205.252 | 옵션
Microsoft.VisualStudio.ComponentGroup.ArchitectureTools.Managed | 아키텍처 및 분석 도구 | 16.5.29514.35 | 옵션
Microsoft.VisualStudio.ComponentGroup.MSIX.Packaging | MSIX 패키징 도구 | 16.10.31205.180 | 옵션
Microsoft.VisualStudio.ComponentGroup.Web | ASP.NET 및 웹 개발 도구 필수 조건 | 16.10.31205.180 | 옵션
...
Microsoft.Net.Component.4.7.1.TargetingPack | .NET Framework 4.7.1 타기팅 팩 | 16.10.31205.252 | 필수
Microsoft.VisualStudio.Component.NuGet | NuGet 패키지 관리자 | 16.1.28829.92 | 필수
Microsoft.VisualStudio.Component.Roslyn.Compiler | C# 및 Visual Basic Roslyn 컴파일러 | 16.0.28714.129 | 필수
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 및 Visual Basic | 16.10.31205.252 | 필수
Microsoft.VisualStudio.Component.Unity | Visual Studio Tools for Unity | 16.0.28315.86 | 필수
Component.UnityEngine.x64 | Unity Hub | 16.10.31205.252 | 권장
...
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 및 웹 개발 | 16.10.31205.180 | 권장
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions.CMake | JSON 편집기 | 16.10.31205.180 | 권장
Component.Incredibuild | Incredibuild - 빌드 가속 | 16.10.31205.252 | 옵션
...
Microsoft.VisualStudio.Component.VC.Tools.ARM64 | MSVC v142 - VS 2019 C++ ARM64 빌드 도구(최신 버전) | 16.10.31205.252 | 옵션
...
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 핵심 기능 | 16.10.31205.252 | 필수
Microsoft.VisualStudio.Component.VC.Redist.14.Latest | C++ 2019 재배포 가능 업데이트 | 16.5.29515.121 | 필수
Microsoft.VisualStudio.Component.VC.Tools.x86.x64 | MSVC v142 - VS 2019 C++ x64/x86 빌드 도구(최신 버전) | 16.10.31205.252 | 필수
...
Microsoft.VisualStudio.Component.VC.DiagnosticTools | C++ 프로파일링 도구 | 16.5.29515.121 | 권장
Microsoft.VisualStudio.Component.Windows10SDK.19041 | Windows 10 SDK(10.0.19041.0) | 16.10.31205.252 | 권장
Component.Android.NDK.R16B | Android NDK(R16B) | 16.10.31320.204 | 옵션
...
Microsoft.Net.Component.4.7.2.TargetingPack | .NET Framework 4.7.2 타기팅 팩 | 16.10.31205.252 | 옵션
Microsoft.Net.Component.4.8.SDK | .NET Framework 4.8 SDK | 16.4.29313.120 | 옵션
...
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 및 Visual Basic | 16.10.31205.252 | 옵션
Microsoft.VisualStudio.Component.Windows10SDK.16299 | Windows 10 SDK(10.0.16299.0) | 16.10.31205.252 | 옵션
Microsoft.VisualStudio.Component.Windows10SDK.17134 | Windows 10 SDK(10.0.17134.0) | 16.10.31205.252 | 옵션
Microsoft.VisualStudio.Component.Windows10SDK.17763 | Windows 10 SDK(10.0.17763.0) | 16.0.28517.75 | 옵션
Microsoft.VisualStudio.Component.Windows10SDK.18362 | Windows 10 SDK(10.0.18362.0) | 16.1.28829.92 | 옵션
...
Component.OpenJDK | OpenJDK(Microsoft 배포) | 16.10.31303.311 | 필수
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 핵심 기능 | 16.10.31205.252 | 필수
Component.Android.NDK.R16B | Android NDK(R16B) | 16.10.31320.204 | 권장
Component.Ant | Apache Ant(1.9.3) | 1.9.3.8 | 권장
Component.MDD.Android | C++ Android 개발 도구 | 16.0.28517.75 | 권장
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 16.10.31305.154 | 권장
Component.Android.NDK.R16B_3264 | Android NDK(R16B)(32비트) | 16.10.31320.204 | 옵션
...
## <a name="net-cross-platform-development"></a>.NET 플랫폼 간 개발

**ID:** Microsoft.VisualStudio.Workload.NetCoreTools

**설명:** Docker 지원이 포함된 .NET, ASP.NET Core, HTML/JavaScript, 컨테이너를 사용하여 플랫폼 간 애플리케이션을 빌드합니다.
...
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 및 웹 개발 | 16.10.31205.180 | 필수
Component.Microsoft.VisualStudio.LiveShare | Live Share | 1.0.4062 | 권장
Component.Microsoft.VisualStudio.Web.AzureFunctions | Azure WebJobs Tools | 16.10.31205.252 | 권장
...
Microsoft.VisualStudio.Component.Web | ASP.NET 및 웹 개발 도구 | 16.10.31205.252 | 권장
Microsoft.VisualStudio.Component.WebDeploy | 웹 배포 | 16.0.28517.75 | 권장
Microsoft.VisualStudio.Component.WslDebugging | WSL 2를 사용한 .NET 디버깅 | 16.10.31303.231 | 권장
Microsoft.VisualStudio.ComponentGroup.AzureFunctions | Azure WebJobs Tools | 16.10.31205.180 | 권장
Microsoft.VisualStudio.ComponentGroup.Web.CloudTools | 웹 개발용 클라우드 도구 | 16.10.31205.180 | 권장
Microsoft.Net.Core.Component.SDK.2.1 | .NET Core 2.1 런타임(LTS) | 16.10.31320.204 | 옵션
Microsoft.VisualStudio.ComponentGroup.IISDevelopment | 개발 시간 IIS 지원 | 16.10.31205.180 | 옵션
Microsoft.VisualStudio.ComponentGroup.MSIX.Packaging | MSIX 패키징 도구 | 16.10.31205.180 | 옵션
...
--- | --- | --- | ---
Component.OpenJDK | OpenJDK(Microsoft 배포) | 16.10.31303.311 | 필수
Component.Xamarin | Xamarin | 16.10.31205.252 | 필수
Component.Xamarin.RemotedSimulator | Xamarin 원격 시뮬레이터 | 16.10.31205.252 | 필수
Microsoft.Component.MSBuild | MSBuild | 16.5.29515.121 | 필수
Microsoft.ComponentGroup.ClickOnce.Publish | .NET용 ClickOnce 게시  | 16.10.31303.231 | 필수
Microsoft.Net.Component.4.6.1.TargetingPack | .NET Framework 4.6.1 타기팅 팩 | 16.0.28517.75 | 필수
Microsoft.Net.Component.4.7.2.TargetingPack | .NET Framework 4.7.2 타기팅 팩 | 16.10.31205.252 | 필수
...
Microsoft.VisualStudio.Component.Roslyn.Compiler | C# 및 Visual Basic Roslyn 컴파일러 | 16.0.28714.129 | 필수
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 및 Visual Basic | 16.10.31205.252 | 필수
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions.TemplateEngine | ASP.NET 템플릿 엔진 | 16.10.31205.180 | 필수
Component.Android.SDK30 | Android SDK 설치(API 레벨 30) | 16.10.31205.252 | 권장
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 16.10.31305.154 | 권장
...
Microsoft.VisualStudio.Component.Web | ASP.NET 및 웹 개발 도구 | 16.10.31205.252 | 필수
Microsoft.VisualStudio.ComponentGroup.Web | ASP.NET 및 웹 개발 도구 필수 조건 | 16.10.31205.180 | 필수
Microsoft.VisualStudio.ComponentGroup.Web.Client | ASP.NET 및 웹 개발 도구 | 16.10.31205.180 | 필수
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 및 웹 개발 | 16.10.31205.180 | 필수
Component.Microsoft.VisualStudio.LiveShare | Live Share | 1.0.4062 | 권장
Component.Microsoft.VisualStudio.Web.AzureFunctions | Azure WebJobs Tools | 16.10.31205.252 | 권장
Microsoft.Net.Component.4.5.1.TargetingPack | .NET Framework 4.5.1 타기팅 팩 | 16.0.28517.75 | 권장
...
Microsoft.VisualStudio.Component.Wcf.Tooling | Windows Communication Foundation | 16.0.28625.61 | 옵션
Microsoft.VisualStudio.ComponentGroup.AdditionalWebProjectTemplates | 추가 프로젝트 템플릿(이전 버전) | 16.10.31205.180 | 옵션
Microsoft.VisualStudio.ComponentGroup.ArchitectureTools.Managed | 아키텍처 및 분석 도구 | 16.5.29514.35 | 옵션
Microsoft.VisualStudio.ComponentGroup.IISDevelopment | 개발 시간 IIS 지원 | 16.10.31205.180 | 옵션
...
구성 요소 ID | Name | 버전 | 종속성 유형
--- | --- | --- | ---
Microsoft.Component.PythonTools | Python 언어 지원 | 16.10.31313.127 | 필수
Component.CPython3.x64 | Python 3 64비트(3.7.8) | 3.7.8 | 권장
Component.CPython2.x64 | Python 2 64비트(2.7.18)(지원되지 않음) | 2.7.18.2 | 옵션
Component.CPython2.x86 | Python 2 32비트(2.7.18)(지원되지 않음) | 2.7.18.2 | 옵션
Component.CPython3.x86 | Python 3 32비트(3.7.8) | 3.7.8 | 옵션
Component.Microsoft.VisualStudio.LiveShare | Live Share | 1.0.4062 | 옵션
Component.Microsoft.VisualStudio.RazorExtension | Razor 언어 서비스 | 16.10.31205.252 | 옵션
Component.Microsoft.Web.LibraryManager | 라이브러리 관리자 | 16.10.31205.180 | Optional
Component.Microsoft.WebTools.BrowserLink.WebLivePreview | 웹 실시간 미리 보기 | 0.7.22.39845 | 선택
Microsoft.Component.IronPython | IronPython(지원되지 않음) | 16.10.31303.231 | 옵션
Microsoft.Component.MSBuild | MSBuild | 16.5.29515.121 | 옵션
Microsoft.Component.PythonTools.Minicondax64 | Python miniconda(지원되지 않음) | 16.10.31313.127 | 선택
Microsoft.Component.PythonTools.Web | Python 웹 지원 | 16.10.31205.252 | 옵션
Microsoft.ComponentGroup.PythonTools.NativeDevelopment | Python 네이티브 개발 도구 | 16.10.31205.180 | 옵션
Microsoft.Net.Component.4.5.2.TargetingPack | .NET Framework 4.5.2 타기팅 팩 | 16.0.28517.75 | 옵션
Microsoft.Net.Component.4.5.TargetingPack | .NET Framework 4.5 타기팅 팩 | 16.0.28517.75 | 옵션
Microsoft.Net.Component.4.7.2.TargetingPack | .NET Framework 4.7.2 타기팅 팩 | 16.10.31205.252 | 옵션
...
Microsoft.VisualStudio.Component.Azure.Compute.Emulator | Azure 컴퓨팅 에뮬레이터 | 16.10.31205.252 | 옵션
Microsoft.VisualStudio.Component.Azure.Storage.Emulator | Azure Storage 계정 | 16.4.29313.120 | 옵션
Microsoft.VisualStudio.Component.Azure.Waverton | Azure Cloud Services 핵심 도구 | 16.10.31205.252 | 옵션
Microsoft.VisualStudio.Component.Azure.Waverton.BuildTools | Azure Cloud Services 빌드 도구 | 16.10.31205.252 | 옵션
Microsoft.VisualStudio.Component.Common.Azure.Tools | 연결 및 게시 도구 | 16.4.29409.204 | 옵션
Microsoft.VisualStudio.Component.Debugger.JustInTime | Just-In-Time 디버거 | 16.0.28517.75 | 옵션
Microsoft.VisualStudio.Component.DockerTools | 컨테이너 개발 도구 | 16.4.29409.204 | 옵션
Microsoft.VisualStudio.Component.Graphics.Tools | DirectX용 그래픽 디버거 및 GPU 프로파일러 | 16.0.28625.61 | 옵션
Microsoft.VisualStudio.Component.IISExpress | IIS Express  | 16.0.28315.86 | 옵션
Microsoft.VisualStudio.Component.JavaScript.Diagnostics | JavaScript 진단 | 16.0.28517.75 | 옵션
Microsoft.VisualStudio.Component.JavaScript.TypeScript | TypeScript 및 JavaScript 언어 지원 | 16.10.31303.231 | 옵션
...
Microsoft.VisualStudio.Component.TypeScript.4.2 | TypeScript 4.2 SDK | 16.0.31303.231 | 옵션
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 핵심 기능 | 16.10.31205.252 | 옵션
Microsoft.VisualStudio.Component.VC.DiagnosticTools | C++ 프로파일링 도구 | 16.5.29515.121 | 옵션
Microsoft.VisualStudio.Component.VC.Tools.x86.x64 | MSVC v142 - VS 2019 C++ x64/x86 빌드 도구(최신 버전) | 16.10.31205.252 | 옵션
Microsoft.VisualStudio.Component.Web | ASP.NET 및 웹 개발 도구 | 16.10.31205.252 | 선택
Microsoft.VisualStudio.Component.WebDeploy | 웹 배포 | 16.0.28517.75 | 옵션
Microsoft.VisualStudio.Component.Windows10SDK | Windows 유니버설 C 런타임 | 16.4.29409.204 | 옵션
Microsoft.VisualStudio.Component.Windows10SDK.19041 | Windows 10 SDK(10.0.19041.0) | 16.10.31205.252 | 옵션
Microsoft.VisualStudio.ComponentGroup.Web | ASP.NET 및 웹 개발 도구 필수 조건 | 16.10.31205.180 | 옵션
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 및 웹 개발 | 16.10.31205.180 | 옵션
...
Microsoft.NetCore.Component.SDK | .NET SDK | 16.10.31320.204 | 필수
Microsoft.VisualStudio.Component.AppInsights.Tools | 개발자 분석 도구 | 16.5.29515.121 | 필수
Microsoft.VisualStudio.Component.DiagnosticTools | .NET 프로파일링 도구 | 16.10.31205.252 | 필수
Microsoft.VisualStudio.Component.Graphics | 이미지 및 3D 모델 편집기 | 16.10.31205.252 | 필수
Microsoft.VisualStudio.Component.NuGet | NuGet 패키지 관리자 | 16.1.28829.92 | 필수
Microsoft.VisualStudio.Component.Roslyn.Compiler | C# 및 Visual Basic Roslyn 컴파일러 | 16.0.28714.129 | 필수
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 및 Visual Basic | 16.10.31205.252 | 필수
Microsoft.VisualStudio.Component.SQL.CLR | SQL Server용 CLR 데이터 형식 | 16.0.28315.86 | 필수
Microsoft.VisualStudio.Component.Windows10SDK.19041 | Windows 10 SDK(10.0.19041.0) | 16.10.31205.252 | 필수
Microsoft.VisualStudio.ComponentGroup.MSIX.Packaging | MSIX 패키징 도구 | 16.10.31205.180 | 필수
Microsoft.VisualStudio.ComponentGroup.UWP.NetCoreAndStandard | .NET 네이티브 및 .NET Standard | 16.3.29102.218 | 필수
Microsoft.VisualStudio.ComponentGroup.UWP.Support | 유니버설 Windows 플랫폼 도구 | 16.10.31205.180 | 필수
Microsoft.VisualStudio.ComponentGroup.UWP.Xamarin | Xamarin용 유니버설 Windows 플랫폼 도구 | 16.10.31205.180 | 필수
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 16.10.31305.154 | 권장
Microsoft.VisualStudio.Component.IntelliTrace.FrontEnd | IntelliTrace | 16.5.29515.121 | 권장
Microsoft.Net.Component.4.8.SDK | .NET Framework 4.8 SDK | 16.4.29313.120 | 옵션
Microsoft.VisualStudio.Component.ClassDesigner | 클래스 디자이너 | 16.0.28528.71 | 옵션
...
Microsoft.VisualStudio.Component.Windows10SDK.17763 | Windows 10 SDK(10.0.17763.0) | 16.0.28517.75 | 옵션
Microsoft.VisualStudio.Component.Windows10SDK.18362 | Windows 10 SDK(10.0.18362.0) | 16.1.28829.92 | 옵션
Microsoft.VisualStudio.Component.Windows10SDK.IpOverUsb | USB 디바이스 연결 | 16.10.31205.252 | 옵션
Microsoft.VisualStudio.ComponentGroup.ArchitectureTools.Managed | 아키텍처 및 분석 도구 | 16.5.29514.35 | 옵션
Microsoft.VisualStudio.ComponentGroup.UWP.VC | C++(v142) 유니버설 Windows 플랫폼 도구 | 16.10.31205.180 | 옵션
...
Microsoft.VisualStudio.ComponentGroup.VisualStudioExtension.Prerequisites | Visual Studio 확장 개발 필수 구성 요소 | 16.10.31205.180 | 필수
Microsoft.VisualStudio.Component.DiagnosticTools | .NET 프로파일링 도구 | 16.10.31205.252 | 권장
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 16.10.31305.154 | 권장
Microsoft.VisualStudio.Component.IntelliTrace.FrontEnd | IntelliTrace | 16.5.29515.121 | 권장
Microsoft.VisualStudio.Component.TextTemplating | 텍스트 템플릿 변환 | 16.0.28625.61 | 권장
...
Microsoft.NetCore.ComponentGroup.DevelopmentTools.2.1 | 개발 도구 및 .NET Core 2.1 | 16.10.31205.252
Microsoft.NetCore.ComponentGroup.Web.2.1 | 웹 개발 도구 및 .NET Core 2.1 | 16.10.31205.252
Microsoft.VisualStudio.Component.AzureDevOps.OfficeIntegration | Azure DevOps Office 통합 | 16.0.28625.61
Microsoft.VisualStudio.Component.Debugger.VSOnline | GitHub Codespaces용 디버거 | 16.10.31205.252
