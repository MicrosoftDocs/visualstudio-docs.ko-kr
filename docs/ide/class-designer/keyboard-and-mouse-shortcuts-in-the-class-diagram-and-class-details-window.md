...
## <a name="use-the-mouse-in-the-class-details-window"></a>클래스 세부 내용 창에서 마우스 사용
...
## <a name="use-the-keyboard-in-the-class-details-window"></a>클래스 세부 내용 창에서 키보드 사용
