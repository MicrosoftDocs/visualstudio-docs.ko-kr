---
description: 중단점 오류 해결 정보를 가져옵니다.
...
`dwFields`\
진행 채울 필드를 결정 하는 [BPERESI_FIELDS](../../../extensibility/debugger/reference/bperesi-fields.md) 열거형의 플래그 조합입니다 `pErrorResolutionInfo` .
