---
title: 스텁을 사용하여 유닛 테스트를 위한 애플리케이션의 여러 부분을 서로 격리 | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="how-to-use-stubs"></a><a name="How"></a> 스텁을 사용 하는 방법

### <a name="design-for-dependency-injection"></a><a name="Dependency"></a> 종속성 주입을 위한 디자인
...
### <a name="generate-stubs"></a><a name="GeneratingStubs"></a> 스텁 생성
...
### <a name="write-your-test-with-stubs"></a><a name="WriteTest"></a> 스텁을 사용 하 여 테스트 작성
...
### <a name="verifying-parameter-values"></a><a name="mocks"></a> 매개 변수 값 확인
...
## <a name="stubs-for-different-kinds-of-type-members"></a><a name="BKMK_Stub_basics"></a> 여러 종류의 형식 멤버에 대 한 스텁

### <a name="methods"></a><a name="BKMK_Methods"></a> 메서드
...
### <a name="events"></a><a name="BKMK_Events"></a> 이벤트
...
### <a name="generic-methods"></a><a name="BKMK_Generic_methods"></a> 제네릭 메서드
...
### <a name="stubs-of-virtual-classes"></a><a name="BKMK_Partial_stubs"></a> 가상 클래스의 스텁
...
## <a name="debugging-stubs"></a><a name="BKMK_Debugging_stubs"></a> 스텁 디버깅
 스텁 형식은 부드러운 디버깅 환경을 제공하도록 설계되었습니다. 기본적으로 디버거는 생성된 코드를 건너뛰도록 지정되어 있으므로 스텁에 연결된 사용자 지정 멤버 구현으로 직접 건너뜁니다.

## <a name="stub-limitations"></a><a name="BKMK_Stub_limitation"></a> 스텁 제한
...
## <a name="changing-the-default-behavior-of-stubs"></a><a name="BKMK_Changing_the_default_behavior_of_stubs"></a> 스텁의 기본 동작 변경
