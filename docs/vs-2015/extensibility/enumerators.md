...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [SccGetCommandOptions](../extensibility/sccgetcommandoptions-function.md) 및 [SccPopulateList](../extensibility/sccpopulatelist-function.md) 함수에 대 한 옵션을 열거 합니다.  
  
 [Message](../extensibility/message-enumerator.md)  
 인쇄 콜백과 [Lptextoutproc](../extensibility/lptextoutproc.md)에 사용 되는 플래그를 열거 합니다.  
 ...
 원본 제어에서 디렉터리의 상태를 지정 하는 명명 된 상수 값을 포함 합니다.  
...
## <a name="related-sections"></a>관련 섹션  
 ...
 지정 된 명령에 대 한 고급 옵션을 사용자에 게 표시 합니다.  
