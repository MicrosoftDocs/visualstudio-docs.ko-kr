---
title: IntelliTrace로 스냅샷 보기
description: IntelliTrace 뒤로 이동을 사용하여 기록 애플리케이션 상태를 검사합니다.
ms.date: 09/20/2018
ms.topic: quickstart
helpviewer_keywords:
...
ms.locfileid: "99933013"
---
# <a name="view-snapshots-with-intellitrace-step-back-visual-studio-enterprise-c-visual-basic-c"></a>IntelliTrace 뒤로 이동을 사용하여 스냅샷 보기(Visual Studio Enterprise)(C#, Visual Basic, C++)
...
자세한 내용은 [IntelliTrace를 사용하여 이전 앱 상태 검사](../debugger/view-historical-application-state.md)를 참조하세요.
