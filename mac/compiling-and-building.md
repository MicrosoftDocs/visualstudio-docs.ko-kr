...
이 섹션의 문서에는 IDE 기반 빌드 프로세스에 대한 자세한 내용이 나와 있습니다. Mac용 Visual Studio를 설치하지 않고 명령줄에서 애플리케이션을 빌드하려면 최신 [.NET Core SDK](https://dotnet.microsoft.com/download)를 설치하면 됩니다. 명령줄을 통해 애플리케이션을 빌드하는 방법에 대한 자세한 내용은 [MSBuild](/visualstudio/msbuild/msbuild)를 참조하세요. Azure Pipelines를 사용하여 애플리케이션을 빌드하는 방법에 대한 자세한 내용은 [Azure Pipelines](/azure/devops/pipelines)를 참조하세요.
