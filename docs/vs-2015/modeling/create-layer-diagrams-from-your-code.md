...
## <a name="create-a-layer-diagram"></a><a name="CreateDiagram"></a> 레이어 다이어그램 만들기
...
## <a name="see-also"></a>관련 항목
 [Channel 9 비디오: 레이어 다이어그램을 사용 하 여 아키텍처 디자인 및 유효성 검사](https://s.ch9.ms/Series/Visual-Studio-2012-Premium-and-Ultimate-Overview/Visual-Studio-Ultimate-2012-Using-layer-diagrams-to-design-and-validate-your-architecture) 레이어 다이어그램: [참조](../modeling/layer-diagrams-reference.md) [레이어 다이어그램: 지침](../modeling/layer-diagrams-guidelines.md) 레이어 [다이어그램으로 코드 유효성 검사](../modeling/validate-code-with-layer-diagrams.md) 코드 [시각화](../modeling/visualize-code.md)
