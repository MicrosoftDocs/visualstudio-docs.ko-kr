---
title: 웹 사이트에 대한 성능 데이터 수집 | Microsoft
description: 성능 마법사를 사용하여 ASP.NET 웹앱의 성능 데이터를 수집하는 방법을 알아봅니다. 앱은 로컬 컴퓨터에서 실행되며 Visual Studio에서 열 수 있습니다.
