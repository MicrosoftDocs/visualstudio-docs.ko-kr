...
|**보기**|보기 방향을 설정합니다. 다음은 사용 가능한 방향입니다.<br /><br /> **앞쪽**<br /> 장면 앞에 보기를 배치합니다.<br /><br /> **뒤로**<br /> 장면 뒤에 보기를 배치합니다.<br /><br /> **왼쪽**<br /> 장면 왼쪽에 보기를 배치합니다.<br /><br /> **오른쪽**<br /> 장면 오른쪽에 보기를 배치합니다.<br /><br /> **위쪽**<br /> 장면 위에 보기를 배치합니다.<br /><br /> **아래쪽**<br /> 장면 아래에 보기를 배치합니다. **참고:**  이것은 **직교** 프로젝션이 사용될 때 보기 방향을 변경하는 유일한 방법입니다.|
|**프로젝션**|장면을 그리는 데 사용되는 프로젝션의 종류를 설정합니다. 다음은 사용 가능한 프로젝션입니다.<br /><br /> **원근감**<br /> 원근 투영 관점에서 뷰포인트에서 멀리 있는 개체는 작게 표시되고, 결국 거리에 따라 한 점으로 수렴합니다.<br /><br /> **직교**<br /> 직교 프로젝션에서는 개체가 뷰포인트로부터의 거리에 관계없이 같은 크기로 나타납니다. 수렴을 표시하지 않습니다. **직교** 프로젝션을 사용하는 경우 **궤도** 모드를 사용하여 보기를 배치할 수 없습니다.|
...
### <a name="control-the-view"></a>뷰 제어

3D 장면은 위치와 방향을 가진 가상 카메라를 떠올릴 수 있는 뷰에 따라 렌더링됩니다. 위치와 방향을 변경하려면 **모델 편집기 모드** 도구 모음에서 뷰 컨트롤을 사용합니다.
...
#### <a name="create-a-hierarchy-that-has-a-parent-object"></a>부모 개체가 있는 계층 구조 만들기

1. **선택** 모드에서 둘 이상의 개체를 선택합니다. 처음 선택하는 것이 부모 개체가 됩니다.

2. **모델 편집기** 도구 모음에서 **스크립트** > **장면 관리** > **부모에 연결**을 차례로 선택합니다.

#### <a name="create-a-hierarchy-of-sibling-objects"></a>형제 개체의 계층 구조 만들기
