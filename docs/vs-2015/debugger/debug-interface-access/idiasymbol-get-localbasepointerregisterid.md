...
ms.locfileid: "90841687"
---
# <a name="idiasymbolget_localbasepointerregisterid"></a>IDiaSymbol::get_localBasePointerRegisterId
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

스택의 지역 변수에 대 한 기본 포인터를 보유 하는 레지스터의 ID를 검색 합니다. [SymTagEnum 열거형](../../debugger/debug-interface-access/symtagenum.md) 이로 설정 된 경우를 사용 `SymTagFunction` 합니다.  
