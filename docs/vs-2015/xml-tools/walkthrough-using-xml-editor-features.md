...
5. ‘hireDate.xsd’ 파일을 선택하고 열기를 클릭합니다.
...
6. 끝 태그가 추가됩니다. 끝 태그는 유효성 검사 오류를 나타내는 물결무늬 밑줄과 함께 추가됩니다. 도구 설명에 다음 메시지가 표시됩니다. "'employee' 요소의 콘텐츠가 완전하지 않습니다. 'ID'가 있어야 합니다."
...
8. **abc**를 입력합니다.
     ...
     **abc** 텍스트에 물결무늬 밑줄이 그어집니다. 도구 설명에 다음 메시지가 표시됩니다. "'ID' 요소 값의 데이터 형식이 잘못되었습니다."
