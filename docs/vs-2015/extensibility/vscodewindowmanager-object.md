...
ms.locfileid: "62421891"
---
# <a name="vscodewindowmanager-object"></a>VSCodeWindowManager 개체
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

언어 서비스는 코드 창 관리자를 구현 하며 장식 (예: 드롭다운 모음) 관리를 담당 합니다. 자세한 내용은 [레거시 API를 사용 하 여 코드 창 사용자 지정](../extensibility/customizing-code-windows-by-using-the-legacy-api.md)을 참조 하세요.  
