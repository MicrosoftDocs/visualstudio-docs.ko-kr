---
title: 'CA5387: 충분 한 반복 횟수로 약한 키 파생 함수를 사용 하지 마십시오.'
...
ms.locfileid: "84184994"
---
# <a name="ca5387-do-not-use-weak-key-derivation-function-with-insufficient-iteration-count"></a>CA5387: 충분 한 반복 횟수로 약한 키 파생 함수를 사용 하지 마십시오.
