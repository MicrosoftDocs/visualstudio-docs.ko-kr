...
description: InvokeDelegate 디자이너와 InvokeDelegate 디자이너를 사용 하 여 InvokeDelegate 활동을 만들고 구성 하는 방법에 대해 알아봅니다.
...
|<xref:System.Activities.Statements.InvokeDelegate.Delegate%2A>|참|작업이 실행될 때 호출할 <xref:System.Activities.ActivityDelegate>의 이름입니다. 이 속성은 디자이너 화면에서 편집할 수 있으며 필수 항목입니다.|
