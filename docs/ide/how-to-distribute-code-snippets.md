...
description: 코드 조각 관리자를 사용하여 코드 조각을 다른 개발자에게 배포하는 방법을 알아봅니다.
...
5. *HelloWorldVB* 가 폴더의 하나로 표시되어야 합니다. 폴더를 두 번 클릭합니다. 드롭다운 **HelloWorldVB** 가 포함된 **코드 조각 삽입: HelloWorldVB >** 팝업이 표시되어야 합니다. **HelloWorldVB** 드롭다운을 클릭합니다.
