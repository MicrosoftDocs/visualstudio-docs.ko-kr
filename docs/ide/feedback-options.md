...
다음으로, Visual Studio에서 로그인하여 아이디어를 공유할 수 있는 [개발자 커뮤니티](https://aka.ms/feedback/suggest?space=8) 인터페이스를 엽니다. 자세한 내용은 [Visual Studio에 대한 기능 제안](suggest-a-feature.md)을 참조하세요.
...
다음으로, Visual Studio에서 로그인하여 아이디어를 공유할 수 있는 [개발자 커뮤니티](https://aka.ms/feedback/suggest?space=8) 페이지를 엽니다. 자세한 내용은 [Visual Studio에 대한 기능 제안](suggest-a-feature.md)을 참조하세요.
