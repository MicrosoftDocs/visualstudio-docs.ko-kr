---
title: 'CA5365: HTTP 헤더 검사를 사용 하지 않도록 설정 하지 마십시오.'
...
ms.locfileid: "84184898"
---
# <a name="ca5365-do-not-disable-http-header-checking"></a>CA5365: HTTP 헤더 검사를 사용 하지 않도록 설정 하지 마십시오.
