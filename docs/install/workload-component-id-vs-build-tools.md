...
수동 설치 관리자를 통해 이러한 구성 요소를 설치하려면 [Build Tools for Visual Studio](https://visualstudio.microsoft.com/downloads/#build-tools-for-visual-studio-2017)를 다운로드하여 실행합니다.
...
수동 설치 관리자를 통해 이러한 구성 요소를 설치하려면 [Build Tools for Visual Studio](https://visualstudio.microsoft.com/downloads/#build-tools-for-visual-studio-2019)를 다운로드하여 실행합니다.
