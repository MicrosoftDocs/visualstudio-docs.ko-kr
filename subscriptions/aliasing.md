...
1. 구독 할당 전자 메일에 포함된 로그인 주소를 사용하여 https://my.visualstudio.com/subscriptions에 로그인합니다.
...
1. Visual Studio 운영 관리 포털 https://manage.visualstudio.com에 액세스 
...
1. https://my.visualstudio.com/subscriptions에 로그인
...
- 첫 번째 옵션(권장)은 디렉터리 계정을 https://my.visualstudio.com의 Visual Studio 구독 포털 로그인으로 사용하는 것입니다.  
