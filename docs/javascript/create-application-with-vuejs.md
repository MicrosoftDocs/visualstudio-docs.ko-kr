...
* Visual Studio를 연 다음 새 프로젝트를 만듭니다.
    ...
    ::: moniker range=">=vs-2019"
    Visual Studio 2019의 시작 창에서 **새 프로젝트 만들기** 를 선택합니다. 시작 창이 열려 있지 않으면 **파일** > **시작 창** 을 선택합니다. **web app** 을 입력하고 **C#** 을 언어로 선택한 다음, **ASP.NET Core 비어 있음** 을 선택한 후 **다음** 을 선택합니다. 다음 화면에서 프로젝트 이름을 **client-app** 로 지정한 후 **다음** 을 선택합니다.
