---
title: DA0013 - String.Split 또는 String.Substring 사용률 높음 | Microsoft Docs
description: System.String.Split 또는 System.String.Substring 메서드 호출이 프로파일링 데이터의 상당한 부분을 차지합니다.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- vs.performance.13
