...
## <a name="in-this-section"></a>섹션 내용  
 ...
 C# 또는 [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] 콘솔 애플리케이션 디버깅에 대한 추가 고려 사항을 제공합니다. 이러한 정보로는 명령줄 인수 지정, 명령 프롬프트에서 애플리케이션 시작, 출력 창에 쓰기, 콘솔 창 문제 해결 등이 있습니다.  
...
## <a name="related-sections"></a>관련 섹션  
 ...
 관리 코드로 작성된 애플리케이션에 관련된 일반적인 디버깅 문제와 디버깅 방법에 대해 설명합니다.  
