...
4. **링크를 만들어 병합 처리**에서 두 개의 경로를 추가 합니다.
   ...
   3. **경로에 링크를 만들어 병합 처리**에서를 클릭 **\<add path>** 합니다.
...
5. DSL 테스트:
   ...
   2. 의 실험적 인스턴스가 시작 되 면 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] DSL의 모델 파일을 엽니다. 몇 가지 예제 요소를 만듭니다.
...
6. DSL 테스트:
    ...
    1. F5 키를 눌러 솔루션을 다시 빌드합니다. 의 실험적 인스턴스가 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 열리면 DSL의 인스턴스를 엽니다.
...
1. [!INCLUDE[dsl](../includes/dsl-md.md)]구성 요소 모델 템플릿을 사용 하 여 솔루션을 만듭니다.
...
10. 솔루션을 빌드하고 실행합니다. 의 새 인스턴스가 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 나타납니다.
