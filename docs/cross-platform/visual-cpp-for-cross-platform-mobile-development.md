...
- **통합된 디버깅 환경.** Visual Studio의 세계적 수준의 디버깅 도구를 사용하여 모든 플랫폼에서 C++ 코드를 감시하고 단계별로 실행합니다. Android 디바이스 및 에뮬레이터, iOS 시뮬레이터 및 디바이스, Windows 또는 Windows 스토어 디바이스 및 에뮬레이터.
