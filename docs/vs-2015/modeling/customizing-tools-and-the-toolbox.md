...
5. DSL을 테스트하려면 F5 키나 Ctrl+F5를 누르고 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]의 실험 인스턴스에서 샘플 모델 파일을 엽니다. 도구 상자에 새 도구가 표시되어야 합니다. 해당 도구를 다이어그램으로 끌어 새 요소가 만들어지는지 확인합니다.
     ...
     도구가 표시되지 않으면 실험 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]를 중지합니다. Windows **시작** 메뉴에서 **Microsoft Visual Studio 2010 실험적 인스턴스 다시 설정**을 실행 합니다. [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] **빌드** 메뉴에서 **솔루션 다시 빌드**를 클릭 합니다. 그런 후에 DSL을 다시 테스트합니다.
...
## <a name="see-also"></a>관련 항목
 [요소 만들기 및 이동 사용자 지정](../modeling/customizing-element-creation-and-movement.md) [복사 동작 사용자 지정](../modeling/customizing-copy-behavior.md) [방법: 끌어서 놓기 처리기 추가](../modeling/how-to-add-a-drag-and-drop-handler.md) [프로그램 코드에서 모델 탐색 및 업데이트](../modeling/navigating-and-updating-a-model-in-program-code.md)
