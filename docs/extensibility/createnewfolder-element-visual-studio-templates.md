---
title: 만들기NewFolder 요소 (비주얼 스튜디오 템플릿) | 마이크로 소프트 문서
ms.date: 11/04/2016
...
---
# <a name="createnewfolder-element-visual-studio-templates"></a>만들기NewFolder 요소(비주얼 스튜디오 템플릿)
