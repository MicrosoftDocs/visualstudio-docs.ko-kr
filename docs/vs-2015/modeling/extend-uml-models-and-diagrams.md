---
title: UML 모델 및 다이어그램 확장 | 마이크로 소프트 문서
ms.date: 11/15/2016
...
이 항목에서는 Visual Studio와 함께 제공된 UML 모델링 도구를 확장할 수 있는 다양한 방법을 간략하게 설명합니다. 각 모델 유형 및 도구를 지원하는 Visual Studio 버전을 확인하려면 [Version support for architecture and modeling tools](../modeling/what-s-new-for-design-in-visual-studio.md#VersionSupport)을 참조하세요.
 ...
 자세한 내용은 이 비디오를 참조하십시오: 비디오 MSDN ![에 대한 링크](../data-tools/media/playvideo.gif "재생 비디오")I[시리즈: UML 도구 및 확장성](https://msdn.microsoft.com/vstudio/ff859492).

## <a name="requirements"></a><a name="Requirements"></a>요구 사항

- [비주얼 스튜디오 SDK](../extensibility/visual-studio-sdk.md).
...
## <a name="profiles"></a>프로필
 ...
 자세한 내용은 [UML을 확장할 프로필 정의를](../modeling/define-a-profile-to-extend-uml.md)참조하십시오.
...
## <a name="custom-toolbox-items"></a>사용자 지정 도구 상자 항목
 ...
 자세한 내용은 [사용자 지정 모델링 도구 상자 항목 정의를](../modeling/define-a-custom-modeling-toolbox-item.md)참조하십시오.
...
## <a name="validation"></a>유효성 검사
 ...
 자세한 내용은 [UML 모델에 대한 유효성 검사 제약 조건 정의를](../modeling/define-validation-constraints-for-uml-models.md)참조하십시오.
...
## <a name="menu-commands"></a>메뉴 명령
 ...
 [모델링 다이어그램에서 메뉴 명령 정의](../modeling/define-a-menu-command-on-a-modeling-diagram.md)를 참조하십시오.
...
## <a name="gestures"></a>제스처
 ...
 자세한 내용은 [모델링 다이어그램의 제스처 처리기 정의를](../modeling/define-a-gesture-handler-on-a-modeling-diagram.md)참조하십시오.
...
## <a name="responding-to-changes"></a>변경에 응답
 ...
 자세한 내용은 [UML 모델의 변경 사항에 응답하는 방법을](../misc/how-to-respond-to-changes-in-a-uml-model.md)참조하십시오.
...
## <a name="model-bus"></a>모델 버스
 ...
 자세한 내용은 [UML 모델과 다른 모델 및 도구를 통합을](../modeling/integrate-uml-models-with-other-models-and-tools.md)참조하십시오.
...
## <a name="generation"></a>Generation
 ...
 자세한 내용은 [UML 모델에서 파일 생성을](../modeling/generate-files-from-a-uml-model.md)참조하십시오.
...
## <a name="team-foundation-server-integration"></a>Team Foundation Server 통합
 ...
 자세한 내용은 [작업 항목 링크 처리기 정의를](../modeling/define-a-work-item-link-handler.md)참조하십시오.
...
## <a name="tools-that-update-models"></a>모델을 업데이트하는 도구
 ...
 자세한 내용은 [프로그램 코드에서 UML 모델 읽기를](../modeling/read-a-uml-model-in-program-code.md)참조하십시오.

## <a name="domain-specific-languages"></a>도메인 특정 언어
 특정 모델 형식을 자주 사용할 경우 도메인 특정 언어를 만드는 것이 유용할 수 있습니다. UML 모델보다 더 밀접하게 비즈니스 요구 사항에 맞추면 도메인 특정 언어를 만들 수 있지만 빌드와 유지 관리에 더 많은 작업이 필요합니다. 자세한 내용은 [Visual Studio - 도메인별 언어에 대한 모델링 SDK를](../modeling/modeling-sdk-for-visual-studio-domain-specific-languages.md)참조하십시오.

## <a name="external-resources"></a>외부 리소스

|**범주**|**링크**|
|------------------|---------------|
|**비디오**|![비디오](../data-tools/media/playvideo.gif "재생 비디오") MSDN에 대한 링크 [I 시리즈를 수행하는 방법 : UML 도구 및 확장성](https://msdn.microsoft.com/vstudio/ff859492)<br /><br /> 비디오 채널 ![9에 대한 링크](../data-tools/media/playvideo.gif "재생 비디오") [: 비주얼 스튜디오와 UML](https://channel9.msdn.com/posts/clinted/)|
...
|**블로그**|[Visual Studio ALM + Team Foundation Server 블로그](https://blogs.msdn.com/b/visualstudioalm)|
|**기술 문서 및 저널**|[MSDN 아키텍처 센터](https://msdn.microsoft.com/architecture/default.aspx)|

## <a name="see-also"></a>참고 항목
 [Create models for your app](../modeling/create-models-for-your-app.md) [UML 모델링 확장성에 대한](../modeling/api-reference-for-uml-modeling-extensibility.md) 앱 API 참조에 대한 모델 만들기
