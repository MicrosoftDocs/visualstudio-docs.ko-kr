...
## <a name="using-frame-analysis"></a>프레임 분석 사용  
 ...
 ![프레임 분석 탭을 선택합니다.](../debugger/media/pix-frame-analysis-select-tab.png "pix_frame_analysis_select_tab")  
...
#### <a name="timeline"></a>타임라인  
 ...
 ![타임라인에 그리기 호출 비용이 표시됩니다.](../debugger/media/pix-frame-analysis-timeline.png "pix_frame_analysis_timeline")  
...
#### <a name="table"></a>표  
 ...
 ![요약 테이블에는 여러 변형이 표시됩니다.](../debugger/media/pix-frame-analysis-summary.png "pix_frame_analysis_summary")  
...
#### <a name="statistical-significance"></a>통계적 중요성  
 ...
 ![그리기 호출 변형의 통계 관련성입니다.](../debugger/media/pix-frame-analysis-summary-stats.png "pix_frame_analysis_summary_stats")  
...
#### <a name="platforms-that-do-not-support-hardware-counters"></a>하드웨어 카운터를 지원하지 않는 플랫폼  
 ...
 ![정보 테이블 및 일부 재생 변형입니다.](../debugger/media/pix-frame-analysis-details.png "pix_frame_analysis_details")  
...
#### <a name="platforms-that-support-hardware-counters"></a>하드웨어 카운터를 지원하는 플랫폼  
 ...
 ![지원되는 경우 하드웨어 카운터가 표시됩니다.](../debugger/media/pix-frame.png "pix_frame")  
...
|**점 질감 필터링**|적절한 모든 질감 샘플의 필터링 모드를 `DXD11_FILTER_MIN_MAG_MIP_POINT`(점 질감 필터링)로 설정합니다.<br /><br /> 자세한 내용은 [점, 쌍선형, 3중 선형 및 이방성 텍스처 필터링 변형](../debugger/point-bilinear-trilinear-and-anisotropic-texture-filtering-variants.md)을 참조하세요.|  
|**쌍선형 질감 필터링**|적절한 모든 질감 샘플의 필터링 모드를 `DXD11_FILTER_MIN_MAG_LINEAR_MIP_POINT`(쌍선형 질감 필터링)로 설정합니다.<br /><br /> 자세한 내용은 [점, 쌍선형, 3중 선형 및 이방성 텍스처 필터링 변형](../debugger/point-bilinear-trilinear-and-anisotropic-texture-filtering-variants.md)을 참조하세요.|  
|**3중 선형 질감 필터링**|적절한 모든 질감 샘플의 필터링 모드를 `DXD11_FILTER_MIN_MAG_MIP_LINEAR`(3중 선형 질감 필터링)로 설정합니다.<br /><br /> 자세한 내용은 [점, 쌍선형, 3중 선형 및 이방성 텍스처 필터링 변형](../debugger/point-bilinear-trilinear-and-anisotropic-texture-filtering-variants.md)을 참조하세요.|  
|**이방성 질감 필터링**|적절한 모든 질감 샘플의 경우 `DXD11_FILTER_ANISOTROPIC` 및 `MaxAnisotropy`에 대한 필터링 모드를 `16`(16x 3중 이방성 질감 필터링)으로 설정합니다.<br /><br /> 자세한 내용은 [점, 쌍선형, 3중 선형 및 이방성 텍스처 필터링 변형](../debugger/point-bilinear-trilinear-and-anisotropic-texture-filtering-variants.md)을 참조하세요.|  
