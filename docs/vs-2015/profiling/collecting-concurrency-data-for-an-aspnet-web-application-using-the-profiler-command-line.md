...
[!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 프로파일링 도구의 동시성 방법을 사용하면 리소스 경합 데이터를 수집할 수 있습니다.  
...
### <a name="profiling-aspnet-applications"></a>ASP.NET 애플리케이션 프로파일링  
...
|작업|관련 내용|  
|----------|---------------------|  
|**독립 실행형(클라이언트) 애플리케이션 프로파일링**|-   [동시성 데이터 수집](../profiling/collecting-concurrency-data-for-stand-alone-applications-by-using-the-profiler-command-line.md)|  
