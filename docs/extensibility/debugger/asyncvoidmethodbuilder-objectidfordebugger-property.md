---
title: 비동기 메서드빌더.ObjectIdForbugger 속성 | 마이크로 소프트 문서
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
ms.locfileid: "80739311"
---
# <a name="asyncvoidmethodbuilderobjectidfordebugger-property"></a>비동기 메서드 빌더.ObjectIdForbugger 속성
