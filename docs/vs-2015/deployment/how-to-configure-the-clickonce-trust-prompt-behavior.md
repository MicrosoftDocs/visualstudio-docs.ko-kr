...
## <a name="enabling-the-clickonce-trust-prompt"></a>ClickOnce 신뢰 프롬프트 사용  
...
1. 레지스트리 편집기를 엽니다.  
    ...
    2. **열기** 상자에 `regedit` (또는 `regedit32` 32 비트 Windows)를 입력 한 다음 **확인**을 클릭 합니다.  
...
## <a name="restricting-the-clickonce-trust-prompt"></a>ClickOnce 신뢰 프롬프트 제한  
...
## <a name="disabling-the-clickonce-trust-prompt"></a>ClickOnce 신뢰 프롬프트 사용 안 함  
