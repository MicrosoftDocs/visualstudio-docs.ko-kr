...
- 이 아닌 [Newtonsoft.json TypeNameHandling](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_TypeNameHandling.htm) 열거형 값 `None` 이 참조 됩니다.
