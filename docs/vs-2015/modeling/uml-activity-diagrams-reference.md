...
||**작업**|동작 다이어그램에 표시되는 작업 흐름입니다. 활동의 속성을 보려면 **UML 모델 탐색기**에서 활동을 선택 해야 합니다.<br /><br /> -   **읽기 전용입니다** . true 이면 활동에서 개체의 상태를 변경 하지 않아야 합니다.<br />-   **단일 실행** -true 인 경우이 다이어그램은 한 번에 최대 한 번 실행 됩니다.|
