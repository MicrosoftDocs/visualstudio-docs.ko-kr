---
title: 구독 지원 솔루션
description: Visual Studio 구독 지원 위젯 콘텐츠의 포함 파일 목록
ms.topic: conceptual
...
ms.locfileid: "100525548"
---
# <a name="visual-studio-subscriptions-support-widget-content-includes-files"></a>Visual Studio 구독 지원 위젯 콘텐츠 포함 파일

## <a name="admin-solutions"></a>관리 솔루션
...
## <a name="benefit-activations"></a>혜택 활성화
...
## <a name="download-activate-or-use-software"></a>소프트웨어 다운로드, 활성화 또는 사용

### <a name="downloads-and-activations"></a>다운로드 및 활성화
...
### <a name="find-and-use-product-keys"></a>제품 키 찾기 및 사용
...
### <a name="use-product-features"></a>제품 기능 사용
...
## <a name="other-solutions-or-no-solution"></a>기타 솔루션 또는 솔루션 없음

[!INCLUDE [No solution](other-or-no-solution/includes/no-solution.md)]

## <a name="portal-issues"></a>포털 이슈
...
## <a name="purchase-renew-or-cancel-subscriptions"></a>구독 구매, 갱신 또는 취소

### <a name="help-with-purchases"></a>구매 관련 도움받기
...
### <a name="help-with-renewals"></a>갱신 관련 도움받기
...
### <a name="help-with-canceling"></a>취소 관련 도움받기
...
### <a name="order-or-purchase-status"></a>주문 또는 구매 상태
...
## <a name="issues-with-signing-in"></a>로그인 관련 문제 
