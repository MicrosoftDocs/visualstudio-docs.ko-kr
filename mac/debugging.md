...
**중단점 창** 으로 이동하여 코드에 설정된 모든 중단점을 볼 수 있습니다.
...
* 기존 중단점에 조건을 추가하려면 중단점을 마우스 오른쪽 단추로 클릭하고 **중단점 속성** 을 선택하거나 **중단점 창** 에서 아래 그림에 표시된 중단점 편집 단추를 선택합니다.

 ![중단점 창에서 기존 중단점 편집](media/debugging-image5.png)
