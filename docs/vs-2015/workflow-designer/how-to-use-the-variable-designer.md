---
title: '방법: 변수 디자이너 사용 | Microsoft Docs'
ms.date: 11/15/2016
...
## <a name="see-also"></a>관련 항목
 [워크플로 디자이너](../workflow-designer/using-the-workflow-designer.md) [변수 및 인수](https://msdn.microsoft.com/library/d03dbe34-5b2e-4f21-8b57-693ee49611b8) 사용 [방법: 인수 디자이너 사용](../workflow-designer/how-to-use-the-argument-designer.md)