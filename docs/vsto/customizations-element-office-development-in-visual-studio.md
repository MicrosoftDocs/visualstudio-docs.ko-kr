...
### <a name="customization"></a>사용자 지정
 필수 사항입니다. `customization`네임 스페이스의 요소는 `vstov4` [Visual Studio&#41;에서 Office 개발 &#40;&#60;사용자 지정&#62; 요소 ](../vsto/customization-element-office-development-in-visual-studio.md)에 정의 됩니다.
