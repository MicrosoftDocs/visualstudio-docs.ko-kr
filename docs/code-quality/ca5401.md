---
title: 'CA5401: 기본값이 아닌 IV와 함께 CreateEncryptor를 사용 하지 마십시오.'
...
ms.locfileid: "84184862"
---
# <a name="ca5401-do-not-use-createencryptor-with-non-default-iv"></a>CA5401: 기본값이 아닌 IV와 함께 CreateEncryptor를 사용 하지 마십시오.
