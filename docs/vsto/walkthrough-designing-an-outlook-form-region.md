...
8. **이 양식 영역을 표시할 메시지 클래스** 를 지정 하십시오. 페이지에서 **메일 메시지** 를 지우고 **연락처** 를 선택한 다음 **마침** 을 클릭 합니다.
     ...
     *Mapit.vb* 또는 *mapit.vb* 파일이 프로젝트에 추가 됩니다.
...
1. **솔루션 탐색기** 에서 **mapitaddin** 프로젝트를 확장 한 다음 *mapit.vb* 또는 *Mapit.vb* 를 두 번 클릭 하 여 양식 영역 디자이너를 엽니다.
...
1. **솔루션 탐색기** 에서 *mapit.vb* 또는 *mapit.vb* 를 마우스 오른쪽 단추로 클릭 한 다음 **코드 보기** 를 클릭 합니다.

    *Mapit.vb* 또는 *Mapit.vb* 가 코드 편집기에서 열립니다.
