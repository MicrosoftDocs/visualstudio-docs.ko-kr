---
description: 오류 중단점 열거에서 다음 요소 집합을 반환 합니다.
...
`rgelt`\
[in, out] 채워질 [IDebugErrorBreakpoint2](../../../extensibility/debugger/reference/idebugerrorbreakpoint2.md) 요소의 배열입니다.
