---
title: 'CA5399: 확실히 HttpClient 인증서 해지 목록 확인을 사용 하지 않도록 설정'
...
ms.locfileid: "84184886"
---
# <a name="ca5399-definitely-disable-httpclient-certificate-revocation-list-check"></a>CA5399: 확실히 HttpClient 인증서 해지 목록 확인을 사용 하지 않도록 설정
