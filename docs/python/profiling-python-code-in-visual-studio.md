...
또는 IronPython에는 고유한 기본 내장 프로파일링이 일부 포함되어 있지만 현재 이를 위한 시각화 도우미가 없습니다. 제공되는 기능에 대해서는 [IronPython 프로파일러](https://blogs.msdn.microsoft.com/curth/2009/03/30/an-ironpython-profiler/)(MSDN 블로그)를 참조하세요.
