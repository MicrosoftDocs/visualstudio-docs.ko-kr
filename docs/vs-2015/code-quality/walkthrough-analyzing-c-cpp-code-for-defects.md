---
title: '연습: 오류에 대C++ 한 C 코드 분석 | Microsoft Docs'
ms.date: 11/15/2016
...
이 연습에서는 C/C++ 코드에 대 한 코드 분석 도구를 사용 하 여 C/C++ 코드에 잠재적 코드 오류를 분석 하는 방법을 보여 줍니다.  
 ...
 이 연습에서는 코드 분석을 사용 하 여 코드 오류에 대 한 C/C++ 코드를 분석 하는 과정을 단계별로 안내 합니다.  
...
- [!INCLUDE[vsPreLong](../includes/vsprelong-md.md)] 또는 [!INCLUDE[vsUltLong](../includes/vsultlong-md.md)]입니다.  
...
1. [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]에서 데모 솔루션을 엽니다.  
...
1. **보기** 메뉴에서 **오류 목록**을 클릭합니다.  
     ...
     [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]에서 선택한 개발자 프로필에 따라 **보기** 메뉴에서 **다른 창** 을 가리킨 다음 **오류 목록**를 클릭 해야 할 수도 있습니다.  
...
1. 다음 예제에 표시 된 것 처럼 사전 및 사후 조건을 사용 하 여 `AddTail` 정식 매개 변수와 함수 반환 값에 주석을 추가 합니다.  
