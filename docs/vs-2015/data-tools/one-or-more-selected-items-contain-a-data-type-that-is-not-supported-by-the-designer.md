---
title: 하나 이상의 선택한 항목에 디자이너에서 지원 하지 않는 데이터 형식이 포함 되어 있습니다. | Microsoft Docs
ms.date: 11/15/2016
...
**서버 탐색기**데이터베이스 탐색기에서로 끌어 온 하나 이상의 항목에에서 / **Database Explorer** [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] 지원 되지 않는 데이터 형식 [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] (예: [CLR 사용자 정의 형식](https://msdn.microsoft.com/library/9f70e0b0-3a0d-4eb1-b914-07a5d0c167c2))이 포함 되어 있습니다.

### <a name="to-correct-this-error"></a>이 오류를 해결하려면

1. 지원되지 않는 데이터 형식이 들어 있지 않은 테이블을 기초로 뷰를 만듭니다.

2. 뷰를 **서버 탐색기** / **데이터베이스 탐색기** 디자이너로 끌어 옵니다.
