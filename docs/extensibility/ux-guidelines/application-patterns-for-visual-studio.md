...
description: Visual Studio의 새로운 기능에 대 한 창 사용 패턴을 포함 하 여 문서 창, 도구 창 및 모덜리스 대화 상자의 차이점에 대해 알아봅니다.
