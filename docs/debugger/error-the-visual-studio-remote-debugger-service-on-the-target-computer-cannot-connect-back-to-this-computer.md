---
description: 이 오류는 디버깅에 사용하려는 컴퓨터에 연결할 때 인증되지 않는 사용자 계정으로 원격 디버거 서비스가 실행되고 있음을 의미합니다.
title: 대상 컴퓨터의 Visual Studio 원격 디버거 서비스가 이 컴퓨터에 다시 연결할 수 없습니다.
titleSuffix: ''
ms.custom: seodec18
ms.date: 11/04/2016
