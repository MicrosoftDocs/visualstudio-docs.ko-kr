---
title: 연결 연결 이름을 만들 수 없습니다. &lt; &gt; 속성 형식이 일치 하지 않습니다. | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>참고 항목
 [방법: LINQ to SQL 클래스 간의 연결 (관계) 만들기](../data-tools/how-to-create-an-association-relationship-between-linq-to-sql-classes-o-r-designer.md) [연습: LINQ to SQL 클래스 만들기 (o-r 디자이너)](https://msdn.microsoft.com/library/35aad4a4-2e8a-46e2-ae09-5fbfd333c233) [LINQ to SQL](https://msdn.microsoft.com/library/73d13345-eece-471a-af40-4cc7a2f11655)
