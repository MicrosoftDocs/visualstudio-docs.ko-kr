---
title: 이름 요소(비주얼 스튜디오 템플릿) | 마이크로 소프트 문서
ms.date: 11/04/2016
...
ms.locfileid: "80702451"
---
# <a name="name-element-visual-studio-templates"></a>이름 요소(비주얼 스튜디오 템플릿)
**새 프로젝트** 또는 **새 항목 추가** 대화 상자에 표시되는 템플릿 이름을 지정합니다.
