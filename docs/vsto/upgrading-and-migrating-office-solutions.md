...
# <a name="upgrade-and-migrate-office-solutions"></a>Office 솔루션 업그레이드 및 마이그레이션
  Microsoft Office 프로젝트를 이전 버전 Visual Studio에서 만든 경우 현재 버전의 Visual Studio에서 사용하려면 프로젝트를 업그레이드해야 합니다. Microsoft Office 프로젝트를 업그레이드하려면 Microsoft Office 개발자 도구가 포함된 Visual Studio 버전에서 프로젝트를 엽니다. Microsoft Office 개발자 도구가 포함된 Visual Studio 버전에 대한 자세한 내용은 [Office 솔루션을 개발할 컴퓨터 구성을](../vsto/configuring-a-computer-to-develop-office-solutions.md)참조하십시오.
...
## <a name="changes-to-upgraded-projects"></a>업그레이드된 프로젝트 변경 사항
 Microsoft Office 프로젝트를 업그레이드하면 Visual Studio에서는 다음 항목을 대상으로 지정하도록 프로젝트를 수정합니다.

- Office 런타임을 위한 Visual Studio 2010 도구입니다. 자세한 내용은 [Office 런타임용 시각적 스튜디오 도구 개요를](../vsto/visual-studio-tools-for-office-runtime-overview.md)참조하십시오.
...
- [!INCLUDE[vsto_runtime](../vsto/includes/vsto-runtime-md.md)]의 어셈블리. 이러한 어셈블리에 대한 자세한 내용은 [Office 런타임용 시각적 스튜디오 도구 개요를](../vsto/visual-studio-tools-for-office-runtime-overview.md)참조하십시오.
...
> [!NOTE]
> 개발 및 최종 사용자 컴퓨터에서 대상이 변경된 솔루션을 실행하려면 몇몇 추가 단계를 수행해야 할 수 있고 프로젝트가 특정 기능을 사용할 경우 프로젝트는 더 이상 컴파일되지 않습니다. 자세한 내용은 [Office 솔루션을 .NET Framework 4 이상으로 마이그레이션을](../vsto/migrating-office-solutions-to-the-dotnet-framework-4-or-later.md)참조하십시오.

 Office 프로젝트에서 [!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)] 이상을 대상으로 지정하면 .NET Framework 3.5를 대상으로 지정할 때는 사용할 수 없는 일부 기능을 사용할 수 있습니다. 자세한 내용은 [Office 솔루션 설계 및 만들기를](../vsto/designing-and-creating-office-solutions.md)참조하십시오.

## <a name="targeted-office-application"></a>대상 사무실 응용 프로그램
...
> [!NOTE]
> VSTO 추가 기능 프로젝트를 대상으로 [!INCLUDE[Office_15_short](../vsto/includes/office-15-short-md.md)] 업그레이드하는 경우 VSTO `ThisAddIn_Startup` 추가 기능의 이벤트 처리기에 응용 프로그램의 문서에 액세스하는 코드가 포함되어 있지 않은지 확인합니다. 자세한 내용은 [Office 응용 프로그램이 시작될 때 문서 액세스를](../vsto/programming-vsto-add-ins.md#AccessingDocuments)참조하십시오.

 문서 수준 사용자 지정의 [!INCLUDE[vs_current_short](../sharepoint/includes/vs-current-short-md.md)] 경우 *.xls* 또는 *.doc* 확장이 있는 문서와 같이 이진 형식이 있는 프로젝트의 문서를 Office Open XML 형식으로 변환합니다. 열기 XML에 대한 자세한 내용은 [새 파일 이름 확장자 및 XML 형식 열기 소개를](https://support.office.com/en-nz/article/Introduction-to-new-file-name-extensions-eca81dcb-5626-4e5b-8362-524d13ae4ec1)참조하십시오.
...
## <a name="upgrade-microsoft-office-2003-projects"></a>업그레이드 마이크로 소프트 오피스 2003 프로젝트
