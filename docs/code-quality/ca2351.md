---
title: 'CA2351: DataSet.ReadXml()의 입력을 신뢰할 수 있는지 확인하세요.'
ms.date: 07/14/2020
ms.topic: reference
author: dotpaul
ms.author: paulming
...
<xref:System.Data.DataSet.ReadXml%2A?displayProperty=nameWithType>메서드를 호출 했거나 참조 했습니다.
...
- 가능 하면 대신 [Entity Framework](https://docs.microsoft.com/ef/) 를 사용 <xref:System.Data.DataSet> 합니다.
