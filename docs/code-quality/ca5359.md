---
title: 'CA5359: 인증서 유효성 검사를 사용 하지 않도록 설정 하지 마십시오.'
...
ms.locfileid: "84185066"
---
# <a name="ca5359-do-not-disable-certificate-validation"></a>CA5359: 인증서 유효성 검사를 사용 하지 않도록 설정 하지 마십시오.
