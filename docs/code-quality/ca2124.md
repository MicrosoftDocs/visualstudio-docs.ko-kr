...
description: .NET Framework 버전 1.0 및 1.1에서 public 또는 protected 메서드에 try/catch/finally 블록이 포함 되어 있습니다. Finally 블록이 보안 상태를 다시 설정 하는 것으로 나타나며 finally 블록에 포함 되지 않습니다.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2124
