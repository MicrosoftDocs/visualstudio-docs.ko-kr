...
titleSuffix: ''
description: 이 연습에서는 연결 된 각 SharePoint 사이트에 웹 파트 갤러리를 표시 하도록 서버 탐색기를 확장 합니다.
...
1. 실험적 인스턴스의 [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)] 메뉴 모음에서 **보기**  >  **서버 탐색기** 를 선택 합니다.
