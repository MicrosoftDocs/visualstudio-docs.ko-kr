...
description: 식별자 이름에 Microsoft 맞춤법 검사 라이브러리에서 인식 하지 못하는 단어가 하나 이상 포함 되어 있습니다. 이 규칙은 get 및 set 속성 접근자와 같은 특수 명명 된 멤버나 생성자를 검사 하지 않습니다.
ms.date: 03/28/2018
ms.topic: reference
f1_keywords:
- CA1704
