...
|영역|키 입력|작업|
|----------|---------------|------------|
|일반 애플리케이션|**Space**|편집 필드 이외의 아무 곳에서나 **Enter** 키 대신 사용합니다.|
...
|Toolbar|**Alt** + **홈**|**도움말 검토자** 홈페이지를 표시합니다.|
...
|항목|**Ctrl** + **탭**|왼쪽에서 오른쪽으로 탭 간에 전환합니다.|
...
|**Ctrl** + **탭**|첫 번째 키 입력을 수행하면 포커스가 **탭 선택** 메뉴로 이동합니다. 다음 키 입력을 수행하면 포커스가 맨 위 메뉴 항목으로 이동하고, 이후 키 입력을 수행하면 포커스가 메뉴 항목으로 위에서 아래 방향으로 이동합니다. 메뉴 항목에 포커스가 있을 때 **Enter** 키를 누르면 항목이 활성 탭이 됩니다.|
