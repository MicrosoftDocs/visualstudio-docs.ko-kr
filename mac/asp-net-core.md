...
.NET Core 3.1은 Mac용 Visual Studio를 설치할 때 자동으로 설치됩니다. Mac용 Visual Studio에서 지원되는 .NET Core 버전에 대한 자세한 내용은 [.NET Core 지원](./net-core-support.md)을 참조하세요.
