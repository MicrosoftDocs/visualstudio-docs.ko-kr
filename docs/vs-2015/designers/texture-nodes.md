...
|**질감 좌표**|현재 픽셀의 질감 좌표입니다.<br /><br /> 질감 좌표는 주위 꼭짓점의 질감 좌표 특성을 보간하여 결정됩니다. 질감 공간에서 현재 픽셀의 위치로 간주할 수 있습니다.<br /><br /> **출력:**<br /><br /> `Output`: `float2`<br /> 질감 좌표입니다.|None|
