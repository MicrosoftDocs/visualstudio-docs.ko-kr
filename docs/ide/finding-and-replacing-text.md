...
description: 찾기 및 바꾸기 기능에 대해 알아보고 이 기능을 사용하여 패턴의 인스턴스를 찾아 바꾸는 방법을 알아봅니다.
...
:::image type="content" source="media/edit-menu-multiple-carets-find-replace.png" alt-text="Visual Studio의 다중 캐럿 플라이아웃 메뉴 스크린샷":::
