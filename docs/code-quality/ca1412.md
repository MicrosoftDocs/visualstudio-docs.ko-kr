...
description: 형식이 ComSourceInterfacesAttribute 특성으로 표시 되어 있고 지정 된 인터페이스 중 하나 이상이 InterfaceIsDispatch 값으로 설정 된 T e m InterfaceTypeAttribute 특성으로 표시 되어 있지 않습니다.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
