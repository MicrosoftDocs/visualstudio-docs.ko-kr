...
## <a name="using-the-test-container"></a>테스트 컨테이너 사용
 ...
 디버깅할 때 컨테이너 코드를 한 단계씩 실행하려면 컨테이너의 디버그 버전을 사용하거나 ActiveX Test Container의 디버그 버전을 사용하십시오. 자세한 내용은 [TSTCON 샘플: ActiveX 컨트롤 테스트 컨테이너](https://msdn.microsoft.com/library/72fa40ef-27d3-400c-813f-10b03236e600)를 참조하세요.
