...
## <a name="benefits"></a>[이점](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs)
구독에 포함된 도구 및 서비스는 혜택 페이지에 “타일”로 표시됩니다.  모든 혜택이 모든 구독에 포함되는 것은 아닙니다. 타일은 도구, 전문적인 개발 및 지원의 세 가지 범주로 그룹화됩니다.  
