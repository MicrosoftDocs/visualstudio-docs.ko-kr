---
title: 프로젝트 속성 참조
description: 프로젝트 속성을 구성하고 사용자 지정하는 방법을 알아봅니다.
...
| [참조 페이지, 프로젝트 디자이너(Visual Basic)](../../ide/reference/references-page-project-designer-visual-basic.md) | 프로젝트에 사용되는 참조를 관리하려면 이 페이지를 사용합니다. |
