...
description: 추적 도메인 속성 및 도메인 모델에 추적 속성을 추가 하는 방법에 대해 알아봅니다.
...
예를 들어 DSL 도구 (Domain-Specific 언어 도구)에서 도메인 클래스의 표시 이름 속성은 도메인 클래스의 이름을 사용 하 여 계산 되는 기본값을 가지 지만 사용자가 디자인 타임에 값을 변경 하거나 계산 된 값으로 다시 설정할 수 있습니다.
