...
2. **새 항목 추가** 대화 상자에서 **리본 (비주얼 디자이너)** 을 선택 하 고 **추가** 를 클릭 합니다.
     ...
     **Ribbon1.xml** 또는 **Ribbon1.xml** 라는 파일이 리본 디자이너에서 열리고 기본 탭 및 그룹이 표시 됩니다.
...
3. **솔루션 탐색기** 에서 *ribbon1.xml* 또는 *ribbon1.xml* 를 선택 합니다.
...
1. **솔루션 탐색기** 에서 *thisaddin* 또는 *thisaddin .vb* 를 선택 합니다.
