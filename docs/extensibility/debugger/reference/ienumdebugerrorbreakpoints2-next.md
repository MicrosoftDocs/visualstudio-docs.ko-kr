---
title: IEnumDebug오류 중단점2::다음 | 마이크로 소프트 문서
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
【인, 아웃】 [입력할 IDebugErrorBreakpoint2](../../../extensibility/debugger/reference/idebugerrorbreakpoint2.md) 요소의 배열입니다.
