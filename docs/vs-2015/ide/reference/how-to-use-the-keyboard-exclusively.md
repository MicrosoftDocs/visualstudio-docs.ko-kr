...
ms.locfileid: "75852369"
---
# <a name="how-to-use-the-keyboard-exclusively"></a>방법: 단독으로 키보드 사용
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

[!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]에서는 IDE(통합 개발 환경) 내에서 쉽게 탐색 및 코딩할 수 있도록 하는 다양한 기본 바로 가기 키 조합을 제공합니다. Visual Studio에서 사용되는 바로 가기 키의 전체 목록은 [기본 바로 가기 키](../../ide/default-keyboard-shortcuts-in-visual-studio.md)를 참조하세요. 다른 Microsoft 제품에서 사용할 수 있는 바로 가기 키에 대 한 자세한 내용은을 참조 하십시오 [http://www.microsoft.com/enable/products/keyboard.aspx](https://www.microsoft.com/enable/products/keyboard.aspx) .
...
2. 옵션 설정을 변경하려면:
    ...
    - 드롭다운 목록에서 **ALT**아래쪽  +  **화살표** 를 사용 하 여 항목을 표시 한 다음 **uparrow** 및 **아래쪽 화살표** 를 사용 하 여 선택한 항목을 변경 합니다.

    - 단추에 대해 **enter** 키를 눌러 호출 합니다.

    - 눈금의 경우 화살표 키를 사용하여 탐색합니다. 모눈의 드롭다운 목록에서 **SHIFT**  +  **ALT**  +  **아래쪽 화살표** 를 사용 하 여 항목을 표시 한 다음 **uparrow** 및 **아래쪽 화살표** 를 사용 하 여 선택한 항목을 변경 합니다.
...
3. **ALT**  +  **스페이스바** 를 누른 다음 **이동**을 선택 합니다.
