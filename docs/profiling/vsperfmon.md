...
description: VSPerfMon 도구를 사용하여 애플리케이션의 성능 데이터를 수집하는 방법을 알아봅니다. 해당 도구는 일반적으로 VSPerfCmd.exe로 시작합니다.
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
- VSPerfMon tool
...
|**WINCOUNTER** `:path`|표시 데이터와 함께 포함할 Windows 성능 카운터를 지정합니다. `path`는 PDH 카운터 경로 형식의 Windows 성능 카운터 문자열입니다. 예를 들면 다음과 같습니다.<br /><br /> \Processor(0)\\% Processor Time<br /><br /> \System\Context Switches/sec|
