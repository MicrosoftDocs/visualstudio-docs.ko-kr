---
title: 도구 창을 사용하여 코드 구조 보기
description: 클래스 뷰, 호출 계층 구조, 개체 브라우저 및 코드 정의(C++에만 해당) 도구 창을 사용하여 Visual Studio에서 클래스 및 해당 멤버를 검사하는 방법을 알아봅니다.
...
**클래스 뷰** 의 바로 가기(또는 오른쪽 클릭) 메뉴에는 선택한 프로젝트의 종류에 따라 다음 명령이 포함될 수 있습니다.
...
**개체 브라우저** 의 바로 가기(또는 오른쪽 클릭) 메뉴에는 선택한 항목의 종류에 따라 다음 명령이 포함될 수 있습니다.
