...
```
 ...
 매크로 목록은 [빌드 명령 및 속성에 대 한 일반 매크로](https://msdn.microsoft.com/library/239bd708-2ea9-4687-b264-043f1febf98b)를 참조 하세요.
...
```
 ...
 호스트가 제공하는 다른 서비스도 가져올 수 있습니다. 자세한 내용은 [템플릿에서 Visual Studio 또는 다른 호스트에 액세스](https://msdn.microsoft.com/0556f20c-fef4-41a9-9597-53afab4ab9e4)를 참조 하세요.
