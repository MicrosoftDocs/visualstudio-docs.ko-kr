...
이 규칙은 입력에서 지정 된 형식을 deserialize 하도록 구성 되었지만 deserialize 된 형식을 Newtonsoft.json로 제한 하도록 구성 되지 않은 JsonSerializerSettings 인스턴스를 [newtonsoft.json](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializerSettings.htm) . [ISerializationBinder](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_Serialization_ISerializationBinder.htm)를 검색 합니다. 입력에서 지정 된 형식의 deserialization을 허용 하지 않으려면 CA2327, [CA2328](ca2328.md), [CA2329](ca2329.md)및 [CA2330](ca2330.md)규칙을 사용 하지 않도록 설정 하 고 대신 rule [CA2326](ca2326.md) 을 사용 하도록 설정 합니다.
