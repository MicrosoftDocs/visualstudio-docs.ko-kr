...
## <a name="in-this-topic"></a><a name="BKMK_In_this_topic"></a> 항목 내용  
 ...
 [Windows 8 데스크톱 응용 프로그램 및 Windows Server 2012 응용 프로그램에만 해당](#BKMK_Windows_8_classic_applications_and_Windows_Server_2012_applications_only)  
...
## <a name="windows-8-desktop-applications-and-windows-server-2012-applications-only"></a><a name="BKMK_Windows_8_classic_applications_and_Windows_Server_2012_applications_only"></a> Windows 8 데스크톱 애플리케이션 및 Windows Server 2012 애플리케이션 전용  
