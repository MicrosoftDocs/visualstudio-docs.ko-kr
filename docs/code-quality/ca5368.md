---
title: 'CA5368: 페이지에서 파생 된 클래스에 대 한 ViewStateUserKey 설정'
...
ms.locfileid: "84185054"
---
# <a name="ca5368-set-viewstateuserkey-for-classes-derived-from-page"></a>CA5368: 페이지에서 파생 된 클래스에 대 한 ViewStateUserKey 설정
