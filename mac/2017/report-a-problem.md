...
1. 발생한 문제를 찾을 수 없는 경우 화면 옆에 있는 **새 문제 보고** 를 선택합니다.
   ...
   > [!NOTE]
   > **새 문제 보고** 단추는 개발자 커뮤니티에 대한 Mac용 Visual Studio 인터페이스에만 표시됩니다. [개발자 커뮤니티](https://aka.ms/feedback/report?space=41/) 웹 사이트에서 직접 문제를 보고할 수 없습니다.
