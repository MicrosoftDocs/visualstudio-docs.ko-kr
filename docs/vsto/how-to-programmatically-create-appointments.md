---
title: '방법: 프로그래밍 방식으로 약속 만들기'
description: 프로그래밍 방식으로 약속을 만든 다음 Microsoft Outlook의 약속 모임 요청에 받는 사람을 추가 하는 방법을 알아봅니다.
