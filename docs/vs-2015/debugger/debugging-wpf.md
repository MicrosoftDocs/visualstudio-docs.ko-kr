...
ms.locfileid: "68152843"
---
# <a name="debugging-wpf"></a>WPF 디버깅
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

[!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)]에서는 WPF 애플리케이션을 보다 쉽게 디버깅할 수 있는 추가 기능을 제공합니다.  
...
|[방법: WPF 추적 정보 표시](../debugger/how-to-display-wpf-trace-information.md)|[!INCLUDE[vsprvs](../includes/vsprvs-md.md)]에서는 WPF 애플리케이션에서 디버그 추적 정보를 받아서 **출력** 창에 표시할 수 있습니다. 이 항목에서는 WPF 추적 정보를 표시하도록 설정하고 표시를 사용자 지정하는 방법을 보여 줍니다.|  
