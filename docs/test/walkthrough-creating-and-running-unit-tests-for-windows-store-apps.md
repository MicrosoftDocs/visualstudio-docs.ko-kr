...
description: Visual Studio의 단위 테스트 UWP(유니버설 Windows 플랫폼) 앱 지원에 대해 알아봅니다. Visual Studio에는 C#, Visual Basic 및 C++에 대한 단위 테스트 템플릿이 포함되어 있습니다.
