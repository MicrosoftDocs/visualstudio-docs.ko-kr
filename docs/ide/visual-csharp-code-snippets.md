---
title: C# 코드 조각
description: 코드 조각을 사용하여 일반적으로 사용되는 코드를 C# 코드 파일에 추가하는 방법을 알아봅니다.
...
|-|[for](/dotnet/csharp/language-reference/keywords/for) 루프를 만듭니다.|메서드, 인덱서, 속성 접근자 또는 이벤트 접근자 내부|
