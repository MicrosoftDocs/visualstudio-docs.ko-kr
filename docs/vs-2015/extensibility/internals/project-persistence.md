...
ms.locfileid: "62429524"
---
# <a name="project-persistence"></a>프로젝트 지속성
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

지 속성은 프로젝트에 중요 한 디자인 고려 사항입니다. 대부분의 프로젝트는 파일을 나타내는 프로젝트 항목을 사용 합니다. [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 는 파일 기반이 아닌 데이터가 있는 프로젝트도 지원 합니다. 프로젝트와 프로젝트 파일이 소유한 파일을 모두 유지 해야 합니다. IDE는 프로젝트에 자체 또는 프로젝트 항목을 저장 하도록 지시 합니다.  
...
## <a name="commit-models"></a>모델 커밋  
 ...
 항목이 파일이 아닌 경우는 `IPersistFileFormat` 여전히 파일 기반이 아닌 항목을 유지 하는 방법입니다. 프로젝트에 대 한 .vbp 파일, 프로젝트에 대 한 .vcproj 파일 등의 프로젝트 파일도 [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] 유지 되어야 합니다.  
