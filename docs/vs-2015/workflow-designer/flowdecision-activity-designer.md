 ...
 **Flowdecision 결정** 디자이너는 **도구 상자**의 **순서도** 범주에 있습니다 .이 범주에 액세스 하려면의 **도구 상자** 탭을 클릭 [!INCLUDE[wfd2](../includes/wfd2-md.md)] 하거나, **보기** 메뉴에서 **도구 모음** 을 선택 하거나, CTRL + ALT + X를 선택 합니다.

 **Flowdecision 결정** 디자이너를 **도구 상자** 에서 끌어다 [!INCLUDE[wfd2](../includes/wfd2-md.md)] **순서도** 활동 디자이너 내에서 화면에 놓을 수 있습니다. 그러면 <xref:System.Activities.Statements.FlowDecision> 활동 내에서 레이블이 지정 된 **의사 결정** 을 만듭니다 <xref:System.Activities.Statements.Flowchart> . 디자이너 위에 마우스를 놓고 두 분기에 대 한 **True** 및 **False** 제곱 핸들을 표시 합니다.
