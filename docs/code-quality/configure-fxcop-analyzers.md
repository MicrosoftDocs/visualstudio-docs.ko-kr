...
ms.locfileid: "90560764"
---
# <a name="configure-net-code-quality-analyzers-with-editorconfig"></a>EditorConfig를 사용 하 여 .NET 코드 품질 분석기 구성

.NET 5.0부터 코드 품질 분석기 ([ `CAxxxx` 규칙](code-analysis-for-managed-code-warnings.md))는 [.net SDK](/dotnet/fundamentals/productivity/code-analysis.md/#code-quality-analysis)에 포함 되어 있습니다. 각 코드 품질 분석기는 구성 가능한 옵션을 통해 코드 베이스의 일부에 적용 되도록 구체화할 수 있습니다. 각 옵션은 [Editorconfig](https://editorconfig.org) 파일에 키-값 쌍을 추가 하 여 지정 합니다. 구성 파일은 파일, 프로젝트, 솔루션 또는 전체 리포지토리에 특정 될 수 있습니다.
...
## <a name="options-for-net-code-quality-analyzers"></a>.NET 코드 품질 분석기에 대 한 옵션
