...
## <a name="in-this-section"></a>섹션 내용  
 ...
 COM 애플리케이션을 디버깅할 때 특별히 고려해야 할 사항에 대해 설명합니다. 여기에는 같은 솔루션 내에서 두 프로젝트를 사용하는 COM 서버 및 컨테이너 디버깅, 프로세스 간 호출 추적, 콜백 함수에 중단점 설정, 컨테이너와 서버 사이의 단계적 실행 등과 같은 내용이 제공됩니다.  
