...
ms.locfileid: "72662745"
---
# <a name="how-to-create-an-empty-workflow-project-legacy"></a>방법: 빈 워크플로 프로젝트 만들기(레거시)
[!INCLUDE[wfd1](../includes/wfd1-md.md)]에서 제공하는 레거시 [!INCLUDE[vs2010](../includes/vs2010-md.md)]를 사용하여 빈 워크플로 프로젝트를 만들려면 다음 단계를 따릅니다. 레거시 [!INCLUDE[wfd2](../includes/wfd2-md.md)]는 [!INCLUDE[netfx35_long](../includes/netfx35-long-md.md)] 또는 [!INCLUDE[vstecwinfx](../includes/vstecwinfx-md.md)]를 대상으로 해야 하는 경우에 사용합니다.

### <a name="to-create-an-empty-workflow-project"></a>빈 워크플로 프로젝트를 만들려면
...
5. **템플릿** 창에서 **빈 워크플로 프로젝트**를 선택 합니다.
