...
description: 두 public 또는 protected 멤버에는 반환 형식을 제외 하 고 동일한 시그니처가 있습니다.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
## <a name="example"></a>예제
다음 예제에서는 MSIL (Microsoft 중간 언어)에서이 규칙을 위반 하는 형식을 보여 줍니다. 이 규칙은 c # 또는 Visual Basic를 사용 하 여 위반할 수 없습니다.
