---
title: "CA2249: ' System.string. IndexOf ' 대신 ' String.format '를 사용 하는 것이 좋습니다."
ms.date: 08/27/2020
ms.topic: reference
f1_keywords:
- CA2249
...
ms.locfileid: "89176902"
---
# <a name="ca2249-consider-using-stringcontains-instead-of-stringindexof"></a>CA2249: string.format 대신 String. Contains를 사용 하는 것이 좋습니다.
...
*: `StringComparison` 이외의 열거형 값 `StringComparison.Ordinal` :
