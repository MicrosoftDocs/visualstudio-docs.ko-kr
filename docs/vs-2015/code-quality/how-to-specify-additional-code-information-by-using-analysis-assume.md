...
> [!NOTE]
> `__analysis_assume`는 코드 최적화에 영향을 주지 않습니다. 코드 분석 도구 외부에서 `__analysis_assume`은 (는) 작동 하지 않는 것으로 정의 됩니다.  
  
## <a name="example"></a>예제  
 다음 코드는 `__analysis_assume`를 사용 하 여 코드 분석 경고 [C6388](../code-quality/c6388.md)를 수정 합니다.  
