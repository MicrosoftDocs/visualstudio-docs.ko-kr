---
title: 프로파일러 명령줄 - 네이티브 서비스 계측, 타이밍 데이터 가져오기
description: Visual Studio 프로파일링 도구 명령줄 도구를 사용하여 네이티브 C/C++ 서비스에 대한 자세한 타이밍 데이터를 수집하는 방법을 알아봅니다.
