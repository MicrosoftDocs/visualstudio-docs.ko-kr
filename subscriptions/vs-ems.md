...
## <a name="who-should-install-ems"></a>EMS를 설치해야 하는 사람은 누구인가요?
Office 365 Developer(E3) 테넌트가 이미 있는 경우 EMS를 설치해야 합니다.  그렇지 않으면 EMS와 Office 365 Developer(E5)를 모두 포함하는 [Microsoft 365](vs-m365.md)를 설치해야 합니다.
