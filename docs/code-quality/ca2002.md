...
- [this](/dotnet/csharp/language-reference/keywords/this) 또는 [Me](/dotnet/visual-basic/programming-guide/program-structure/me-my-mybase-and-myclass) 개체 (FxCop 3.0부터 시작)
