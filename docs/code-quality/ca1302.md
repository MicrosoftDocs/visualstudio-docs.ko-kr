...
description: 메서드는 특정 시스템 폴더의 경로 부분을 나타내는 문자열 리터럴을 사용 합니다.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
[CA1303: 리터럴을 지역화된 매개 변수로 전달하지 마세요.](/dotnet/fundamentals/code-analysis/quality-rules/ca1303)
