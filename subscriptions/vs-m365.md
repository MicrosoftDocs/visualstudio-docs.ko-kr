---
title: Visual Studio 구독의 Microsoft 365 개발자 구독 혜택 | Microsoft Docs
author: evanwindom
ms.author: v-evwin
manager: lank
ms.assetid: ''
...
Microsoft 365 E5 개발자 구독에 포함된 사항에 대해 알아보려면 [Microsoft 365 개발자 프로그램 FAQ](https://docs.microsoft.com/office/developer-program/microsoft-365-developer-program-faq#whats-included-in-the-developer-subscription)를 참조하세요.
...
0. "도구" 범주에서 Microsoft 365 혜택 타일을 찾아 **활성화**를 클릭합니다.
    ...
    >![Microsoft 365 개발자 타일](_img/visualstudio-microsoft365/visualstudio-microsoft365-tile.png)
...
1. 새 Microsoft 365 E5 구독의 설정 프로세스가 자동으로 시작됩니다.
    ...
    > [!div class="mx-imgBorder"]
    >![Microsoft 365 마이그레이션 프로세스](_img/visualstudio-microsoft365/visualstudio-microsoft365-migration.png)
...
- [Microsoft 365 테넌트 간에 사서함을 마이그레이션하는 방법](https://docs.microsoft.com/exchange/mailbox-migration/migrate-mailboxes-across-tenants)
- [PowerShell을 사용하여 Office 365에 대한 단계적 마이그레이션 수행](https://docs.microsoft.com/office365/enterprise/powershell/use-powershell-to-perform-a-staged-migration-to-office-365)
- [Office 365에서 Microsoft 365로 마이그레이션 가이드](https://docs.microsoft.com/sharepointmigration/mover-o365-to-o365) Microsoft 365 개발자 프로그램의 멤버 자격을 사용해 주셔서 감사합니다.
...
- Microsoft 365 개발자 구독과 관련하여 도움이 필요하세요?  온라인 [Microsoft 365 설명서](https://docs.microsoft.com/office/developer-program/office-365-developer-program-faq)를 확인하세요.
...
- https://my.visualstudio.com/benefits 에 로그인하고 Microsoft 365 개발자 구독 타일을 클릭하여 시작합니다. 
