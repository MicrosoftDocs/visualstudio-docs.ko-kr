...
description: Visual Studio에서 DefaultBindingPropertyAttribute 클래스를 사용 하 여 간단한 데이터 바인딩을 지 원하는 Windows Forms 사용자 정의 컨트롤을 만드는 방법에 대해 알아봅니다.
