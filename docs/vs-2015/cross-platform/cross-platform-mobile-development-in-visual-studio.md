...
- [Android, iOS 및 Windows용 앱 빌드(.NET Framework)](#NET)
  ...
  - [단일 코드 베이스에서 Android, iOS 및 Windows 대상 지정](../cross-platform/cross-platform-mobile-development-in-visual-studio.md#AndroidHTML)
...
- [Unity용 비주얼 스튜디오 도구를 사용하여 Android, iOS 및 Windows용 크로스 플랫폼 게임 구축](#Unity)

## <a name="build-an-app-for-android-ios-and-windows-net-framework"></a><a name="NET"></a>안드로이드, iOS 및 Windows용 앱 빌드(.NET 프레임워크)
...
|[비주얼 스튜디오(VisualStudio.com)에서 범용 Windows 앱에 대해 알아보기](https://www.visualstudio.com/vs/universal-windows-platform/)|
...
### <a name="target-windows-10-devices"></a><a name="WindowsHTML"></a>대상 윈도우 10 장치
 ![윈도우 장치](../cross-platform/media/windowsdevices.png "Windows 장치")
...
## <a name="build-an-app-for-android-ios-and-windows-htmljavascript"></a><a name="HTML"></a>안드로이드, iOS 및 Windows용 앱 빌드(HTML/자바스크립트)
 ![디바이스](../cross-platform/media/homedevices.png "HomeDevices")
 ...
 ![멀티&#45;장치 하이브리드 앱](../cross-platform/media/multidevicehybridapps.png "멀티 디바이스하이브리드앱")
...
## <a name="build-an-app-for-android-and-windows-c"></a><a name="CPP"></a>안드로이드와 윈도우용 앱 구축(C++)
 ...
 ![Native Activity 프로젝트 템플릿](../cross-platform/media/cross-plat-cpp-native.png "크로스 Plat_CPP_Native")
...
|**자세히 알아보기**|
|--------------------|
|[비주얼 스튜디오를 다운로드합니다.](https://visualstudio.microsoft.com/vs/community/) (VisualStudio.com)|
...
## <a name="build-a-cross-platform-game-for-android-ios-and-windows-by-using-visual-studio-tools-for-unity"></a><a name="Unity"></a> Visual Studio Tools for Unity를 사용하여 Android, iOS 및 Windows용 플랫폼 간 게임 빌드
