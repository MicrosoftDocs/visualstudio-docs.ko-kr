---
title: 'CA2016: 하나를 사용 하는 메서드에 CancellationToken 매개 변수를 전달 합니다.'
ms.date: 06/18/2020
ms.topic: reference
f1_keywords:
...
ms.locfileid: "85837719"
---
# <a name="ca2016-forward-the-cancellationtoken-parameter-to-methods-that-take-one"></a>CA2016: 하나를 사용 하는 메서드에 CancellationToken 매개 변수를 전달 합니다.
