---
title: C#을 사용하여 Windows Forms 앱 만들기
description: Visual Studio에서 C#을 사용하여 Windows Forms 앱을 만드는 방법을 단계별로 알아봅니다.
ms.date: 09/26/2019
ms.topic: tutorial
...
ms.locfileid: "112308313"
---
# <a name="create-a-windows-forms-app-in-visual-studio-with-c"></a>Visual Studio에서 C\#을 사용하여 Windows Forms 앱 만들기

Visual Studio IDE(통합 개발 환경)에 대한 이 짧은 소개에서는 Windows 기반 UI(사용자 인터페이스)가 있는 간단한 C# 애플리케이션을 만듭니다.
...
1. **Pin** 아이콘을 클릭하여 **도구 상자** 창을 고정합니다.
     ...
     ![Pin 아이콘을 선택하여 도구 상자 창을 IDE에 고정합니다.](../ide/media/vb-pin-the-toolbox-window.png)

1. **단추** 컨트롤을 선택하고 다음 양식으로 끌어옵니다.
...
1. **Form1.cs** 창의 **private void** 줄 다음에 다음 스크린샷과 같이 `lblHelloWorld.Text = "Hello World!";`를 입력합니다.
     ...
     ![양식에 코드 추가](../get-started/csharp/media/csharp-winforms-add-code.png)

## <a name="run-the-application"></a>애플리케이션 실행

1. **시작** 단추를 선택하여 애플리케이션을 실행합니다.
