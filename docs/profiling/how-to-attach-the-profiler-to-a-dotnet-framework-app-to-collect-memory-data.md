---
title: .NET에 프로파일러를 연결하여 메모리 데이터 수집
description: Visual Studio 프로파일링 도구 명령줄 도구를 사용하여 실행 중인 .NET Framework 독립 실행형(클라이언트) 앱에 프로파일러를 연결하고 메모리 데이터를 가져오는 방법을 알아봅니다.
